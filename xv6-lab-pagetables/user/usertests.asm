...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	d5250513          	addi	a0,a0,-686 # 5d90 <malloc+0xe6>
      ...
      74:	8082                	ret
{
      ...
      84:	d3050513          	addi	a0,a0,-720 # 5db0 <malloc+0x106>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	d2050513          	addi	a0,a0,-736 # 5dc8 <malloc+0x11e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	d2250513          	addi	a0,a0,-734 # 5de8 <malloc+0x13e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	cea50513          	addi	a0,a0,-790 # 5dd0 <malloc+0x126>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	cf650513          	addi	a0,a0,-778 # 5df8 <malloc+0x14e>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	cf450513          	addi	a0,a0,-780 # 5e20 <malloc+0x176>
     134:	00005097          	auipc	ra,0x5
     138:	774080e7          	jalr	1908(ra) # 58a8 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	ce050513          	addi	a0,a0,-800 # 5e20 <malloc+0x176>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	cdc58593          	addi	a1,a1,-804 # 5e30 <malloc+0x186>
     15c:	00005097          	auipc	ra,0x5
     160:	71c080e7          	jalr	1820(ra) # 5878 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	cb850513          	addi	a0,a0,-840 # 5e20 <malloc+0x176>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	cbc58593          	addi	a1,a1,-836 # 5e38 <malloc+0x18e>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	c8c50513          	addi	a0,a0,-884 # 5e20 <malloc+0x176>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	c7650513          	addi	a0,a0,-906 # 5e40 <malloc+0x196>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	bec50513          	addi	a0,a0,-1044 # 5e68 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	bd8a8a93          	addi	s5,s5,-1064 # 5e68 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	b6650513          	addi	a0,a0,-1178 # 5e78 <malloc+0x1ce>
     ...
     338:	b6450513          	addi	a0,a0,-1180 # 5e98 <malloc+0x1ee>
     33c:	00006097          	auipc	ra,0x6
     340:	8b6080e7          	jalr	-1866(ra) # 5bf2 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	b40a0a13          	addi	s4,s4,-1216 # 5eb0 <malloc+0x206>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	a9c50513          	addi	a0,a0,-1380 # 5eb8 <malloc+0x20e>
     424:	00005097          	auipc	ra,0x5
     428:	7ce080e7          	jalr	1998(ra) # 5bf2 <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	a9650513          	addi	a0,a0,-1386 # 5ed0 <malloc+0x226>
     442:	00005097          	auipc	ra,0x5
     446:	7b0080e7          	jalr	1968(ra) # 5bf2 <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	aa850513          	addi	a0,a0,-1368 # 5f00 <malloc+0x256>
     460:	00005097          	auipc	ra,0x5
     464:	792080e7          	jalr	1938(ra) # 5bf2 <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	abe50513          	addi	a0,a0,-1346 # 5f30 <malloc+0x286>
     47a:	00005097          	auipc	ra,0x5
     47e:	778080e7          	jalr	1912(ra) # 5bf2 <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	ab050513          	addi	a0,a0,-1360 # 5f40 <malloc+0x296>
     498:	00005097          	auipc	ra,0x5
     49c:	75a080e7          	jalr	1882(ra) # 5bf2 <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	aa2a0a13          	addi	s4,s4,-1374 # 5f70 <malloc+0x2c6>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	962a8a93          	addi	s5,s5,-1694 # 5e38 <malloc+0x18e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	9fc50513          	addi	a0,a0,-1540 # 5f78 <malloc+0x2ce>
     584:	00005097          	auipc	ra,0x5
     588:	66e080e7          	jalr	1646(ra) # 5bf2 <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	9f650513          	addi	a0,a0,-1546 # 5f90 <malloc+0x2e6>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	650080e7          	jalr	1616(ra) # 5bf2 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	97c50513          	addi	a0,a0,-1668 # 5f30 <malloc+0x286>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	636080e7          	jalr	1590(ra) # 5bf2 <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	9f250513          	addi	a0,a0,-1550 # 5fc0 <malloc+0x316>
     5d6:	00005097          	auipc	ra,0x5
     5da:	61c080e7          	jalr	1564(ra) # 5bf2 <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	9ec50513          	addi	a0,a0,-1556 # 5fd8 <malloc+0x32e>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	5fe080e7          	jalr	1534(ra) # 5bf2 <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	7ee58593          	addi	a1,a1,2030 # 5e30 <malloc+0x186>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	7c250513          	addi	a0,a0,1986 # 5e20 <malloc+0x176>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	79650513          	addi	a0,a0,1942 # 5e20 <malloc+0x176>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	78250513          	addi	a0,a0,1922 # 5e20 <malloc+0x176>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	98c58593          	addi	a1,a1,-1652 # 6068 <malloc+0x3be>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	70250513          	addi	a0,a0,1794 # 5e20 <malloc+0x176>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	8a650513          	addi	a0,a0,-1882 # 6008 <malloc+0x35e>
     76a:	00005097          	auipc	ra,0x5
     76e:	488080e7          	jalr	1160(ra) # 5bf2 <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	8aa50513          	addi	a0,a0,-1878 # 6028 <malloc+0x37e>
     786:	00005097          	auipc	ra,0x5
     78a:	46c080e7          	jalr	1132(ra) # 5bf2 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	8a650513          	addi	a0,a0,-1882 # 6038 <malloc+0x38e>
     79a:	00005097          	auipc	ra,0x5
     79e:	458080e7          	jalr	1112(ra) # 5bf2 <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	8aa50513          	addi	a0,a0,-1878 # 6058 <malloc+0x3ae>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	43c080e7          	jalr	1084(ra) # 5bf2 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7be:	8652                	mv	a2,s4
     7c0:	85d6                	mv	a1,s5
     7c2:	00006517          	auipc	a0,0x6
     7c6:	87650513          	addi	a0,a0,-1930 # 6038 <malloc+0x38e>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	428080e7          	jalr	1064(ra) # 5bf2 <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	89050513          	addi	a0,a0,-1904 # 6070 <malloc+0x3c6>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	40a080e7          	jalr	1034(ra) # 5bf2 <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	89250513          	addi	a0,a0,-1902 # 6090 <malloc+0x3e6>
     806:	00005097          	auipc	ra,0x5
     80a:	3ec080e7          	jalr	1004(ra) # 5bf2 <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	87e50513          	addi	a0,a0,-1922 # 60b0 <malloc+0x406>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	88e98993          	addi	s3,s3,-1906 # 60d8 <malloc+0x42e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	8bea8a93          	addi	s5,s5,-1858 # 6110 <malloc+0x466>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	81850513          	addi	a0,a0,-2024 # 60b0 <malloc+0x406>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	7dc50513          	addi	a0,a0,2012 # 60b0 <malloc+0x406>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	7ba50513          	addi	a0,a0,1978 # 60b8 <malloc+0x40e>
     906:	00005097          	auipc	ra,0x5
     90a:	2ec080e7          	jalr	748(ra) # 5bf2 <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	7cc50513          	addi	a0,a0,1996 # 60e8 <malloc+0x43e>
     924:	00005097          	auipc	ra,0x5
     928:	2ce080e7          	jalr	718(ra) # 5bf2 <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	7e650513          	addi	a0,a0,2022 # 6120 <malloc+0x476>
     942:	00005097          	auipc	ra,0x5
     946:	2b0080e7          	jalr	688(ra) # 5bf2 <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	7f250513          	addi	a0,a0,2034 # 6148 <malloc+0x49e>
     95e:	00005097          	auipc	ra,0x5
     962:	294080e7          	jalr	660(ra) # 5bf2 <printf>
    exit(1);
     966:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     976:	7f650513          	addi	a0,a0,2038 # 6168 <malloc+0x4be>
     97a:	00005097          	auipc	ra,0x5
     97e:	278080e7          	jalr	632(ra) # 5bf2 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	7f250513          	addi	a0,a0,2034 # 6180 <malloc+0x4d6>
     996:	00005097          	auipc	ra,0x5
     99a:	25c080e7          	jalr	604(ra) # 5bf2 <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	7e050513          	addi	a0,a0,2016 # 61a0 <malloc+0x4f6>
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	78e50513          	addi	a0,a0,1934 # 61a0 <malloc+0x4f6>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	74e50513          	addi	a0,a0,1870 # 61a8 <malloc+0x4fe>
     a62:	00005097          	auipc	ra,0x5
     a66:	190080e7          	jalr	400(ra) # 5bf2 <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	75050513          	addi	a0,a0,1872 # 61c8 <malloc+0x51e>
     a80:	00005097          	auipc	ra,0x5
     a84:	172080e7          	jalr	370(ra) # 5bf2 <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	75c50513          	addi	a0,a0,1884 # 61f0 <malloc+0x546>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	156080e7          	jalr	342(ra) # 5bf2 <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	6e050513          	addi	a0,a0,1760 # 61a0 <malloc+0x4f6>
     ...
     af0:	72450513          	addi	a0,a0,1828 # 6210 <malloc+0x566>
     af4:	00005097          	auipc	ra,0x5
     af8:	0fe080e7          	jalr	254(ra) # 5bf2 <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	72e50513          	addi	a0,a0,1838 # 6238 <malloc+0x58e>
     b12:	00005097          	auipc	ra,0x5
     b16:	0e0080e7          	jalr	224(ra) # 5bf2 <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	72850513          	addi	a0,a0,1832 # 6250 <malloc+0x5a6>
     b30:	00005097          	auipc	ra,0x5
     b34:	0c2080e7          	jalr	194(ra) # 5bf2 <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	73450513          	addi	a0,a0,1844 # 6278 <malloc+0x5ce>
     b4c:	00005097          	auipc	ra,0x5
     b50:	0a6080e7          	jalr	166(ra) # 5bf2 <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	71e50513          	addi	a0,a0,1822 # 6290 <malloc+0x5e6>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	73658593          	addi	a1,a1,1846 # 62c0 <malloc+0x616>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	6ea50513          	addi	a0,a0,1770 # 6290 <malloc+0x5e6>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	6d450513          	addi	a0,a0,1748 # 6290 <malloc+0x5e6>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	6be50513          	addi	a0,a0,1726 # 6290 <malloc+0x5e6>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	72258593          	addi	a1,a1,1826 # 6308 <malloc+0x65e>
  ...
  unlink("unlinkread");
     ...
     c52:	64250513          	addi	a0,a0,1602 # 6290 <malloc+0x5e6>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	63250513          	addi	a0,a0,1586 # 62a0 <malloc+0x5f6>
     c76:	00005097          	auipc	ra,0x5
     c7a:	f7c080e7          	jalr	-132(ra) # 5bf2 <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	63e50513          	addi	a0,a0,1598 # 62c8 <malloc+0x61e>
     c92:	00005097          	auipc	ra,0x5
     c96:	f60080e7          	jalr	-160(ra) # 5bf2 <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	64250513          	addi	a0,a0,1602 # 62e8 <malloc+0x63e>
     cae:	00005097          	auipc	ra,0x5
     cb2:	f44080e7          	jalr	-188(ra) # 5bf2 <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	64e50513          	addi	a0,a0,1614 # 6310 <malloc+0x666>
     cca:	00005097          	auipc	ra,0x5
     cce:	f28080e7          	jalr	-216(ra) # 5bf2 <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	65250513          	addi	a0,a0,1618 # 6330 <malloc+0x686>
     ce6:	00005097          	auipc	ra,0x5
     cea:	f0c080e7          	jalr	-244(ra) # 5bf2 <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	65650513          	addi	a0,a0,1622 # 6350 <malloc+0x6a6>
     d02:	00005097          	auipc	ra,0x5
     d06:	ef0080e7          	jalr	-272(ra) # 5bf2 <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	56258593          	addi	a1,a1,1378 # 62c0 <malloc+0x616>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	5fa58593          	addi	a1,a1,1530 # 6378 <malloc+0x6ce>
     d86:	00005517          	auipc	a0,0x5
     d8a:	5ea50513          	addi	a0,a0,1514 # 6370 <malloc+0x6c6>
  ...
  unlink("lf1");
     ...
     d9e:	5d650513          	addi	a0,a0,1494 # 6370 <malloc+0x6c6>
     da2:	00005097          	auipc	ra,0x5
     da6:	b06080e7          	jalr	-1274(ra) # 58a8 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	5c450513          	addi	a0,a0,1476 # 6370 <malloc+0x6c6>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	5b650513          	addi	a0,a0,1462 # 6378 <malloc+0x6ce>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	57e58593          	addi	a1,a1,1406 # 6378 <malloc+0x6ce>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	56850513          	addi	a0,a0,1384 # 6378 <malloc+0x6ce>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a90080e7          	jalr	-1392(ra) # 58a8 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	55058593          	addi	a1,a1,1360 # 6370 <malloc+0x6c6>
     e28:	00005517          	auipc	a0,0x5
     e2c:	55050513          	addi	a0,a0,1360 # 6378 <malloc+0x6ce>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	53458593          	addi	a1,a1,1332 # 6370 <malloc+0x6c6>
     e44:	00005517          	auipc	a0,0x5
     e48:	63c50513          	addi	a0,a0,1596 # 6480 <malloc+0x7d6>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	51a50513          	addi	a0,a0,1306 # 6380 <malloc+0x6d6>
     e6e:	00005097          	auipc	ra,0x5
     e72:	d84080e7          	jalr	-636(ra) # 5bf2 <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	51650513          	addi	a0,a0,1302 # 6398 <malloc+0x6ee>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	d68080e7          	jalr	-664(ra) # 5bf2 <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	51250513          	addi	a0,a0,1298 # 63b0 <malloc+0x706>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	d4c080e7          	jalr	-692(ra) # 5bf2 <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	51650513          	addi	a0,a0,1302 # 63d0 <malloc+0x726>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	52a50513          	addi	a0,a0,1322 # 6400 <malloc+0x756>
     ede:	00005097          	auipc	ra,0x5
     ee2:	d14080e7          	jalr	-748(ra) # 5bf2 <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	52650513          	addi	a0,a0,1318 # 6418 <malloc+0x76e>
     efa:	00005097          	auipc	ra,0x5
     efe:	cf8080e7          	jalr	-776(ra) # 5bf2 <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	52250513          	addi	a0,a0,1314 # 6430 <malloc+0x786>
     f16:	00005097          	auipc	ra,0x5
     f1a:	cdc080e7          	jalr	-804(ra) # 5bf2 <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	52e50513          	addi	a0,a0,1326 # 6458 <malloc+0x7ae>
     f32:	00005097          	auipc	ra,0x5
     f36:	cc0080e7          	jalr	-832(ra) # 5bf2 <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	54250513          	addi	a0,a0,1346 # 6488 <malloc+0x7de>
     f4e:	00005097          	auipc	ra,0x5
     f52:	ca4080e7          	jalr	-860(ra) # 5bf2 <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	4fca0a13          	addi	s4,s4,1276 # 64a8 <malloc+0x7fe>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	4aa50513          	addi	a0,a0,1194 # 64a8 <malloc+0x7fe>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	44250513          	addi	a0,a0,1090 # 64b0 <malloc+0x806>
    1076:	00005097          	auipc	ra,0x5
    107a:	b7c080e7          	jalr	-1156(ra) # 5bf2 <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	44250513          	addi	a0,a0,1090 # 64d0 <malloc+0x826>
    1096:	00005097          	auipc	ra,0x5
    109a:	b5c080e7          	jalr	-1188(ra) # 5bf2 <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	44650513          	addi	a0,a0,1094 # 64f0 <malloc+0x846>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	b40080e7          	jalr	-1216(ra) # 5bf2 <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	43498993          	addi	s3,s3,1076 # 6510 <malloc+0x866>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	40850513          	addi	a0,a0,1032 # 6520 <malloc+0x876>
    1120:	00005097          	auipc	ra,0x5
    1124:	ad2080e7          	jalr	-1326(ra) # 5bf2 <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    1188:	c4498993          	addi	s3,s3,-956 # 5dc8 <malloc+0x11e>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	50a78793          	addi	a5,a5,1290 # 7718 <malloc+0x1a6e>
  ...
  if(pid == 0){
    ...
    126e:	eee78793          	addi	a5,a5,-274 # 8158 <malloc+0x24ae>
    ...
    1292:	b3a50513          	addi	a0,a0,-1222 # 5dc8 <malloc+0x11e>
    ...
    12aa:	32250513          	addi	a0,a0,802 # 65c8 <malloc+0x91e>
    12ae:	00005097          	auipc	ra,0x5
    12b2:	944080e7          	jalr	-1724(ra) # 5bf2 <printf>
      exit(1);
    12b6:	4505                	li	a0,1
    ...
    12ca:	27a50513          	addi	a0,a0,634 # 6540 <malloc+0x896>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	924080e7          	jalr	-1756(ra) # 5bf2 <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	27a50513          	addi	a0,a0,634 # 6560 <malloc+0x8b6>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	904080e7          	jalr	-1788(ra) # 5bf2 <printf>
    exit(1);
    12f6:	4505                	li	a0,1
    ...
    130c:	27850513          	addi	a0,a0,632 # 6580 <malloc+0x8d6>
    1310:	00005097          	auipc	ra,0x5
    1314:	8e2080e7          	jalr	-1822(ra) # 5bf2 <printf>
    exit(1);
    1318:	4505                	li	a0,1
    ...
    132c:	28050513          	addi	a0,a0,640 # 65a8 <malloc+0x8fe>
    1330:	00005097          	auipc	ra,0x5
    1334:	8c2080e7          	jalr	-1854(ra) # 5bf2 <printf>
    exit(1);
    1338:	4505                	li	a0,1
    ...
    1346:	6fe50513          	addi	a0,a0,1790 # 6a40 <malloc+0xd96>
    134a:	00005097          	auipc	ra,0x5
    134e:	8a8080e7          	jalr	-1880(ra) # 5bf2 <printf>
    exit(1);
    1352:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1390:	26450513          	addi	a0,a0,612 # 65f0 <malloc+0x946>
    1394:	00005097          	auipc	ra,0x5
    1398:	85e080e7          	jalr	-1954(ra) # 5bf2 <printf>
    exit(1);
    139c:	4505                	li	a0,1
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	a6250513          	addi	a0,a0,-1438 # 5e20 <malloc+0x176>
  ...
  if(pid == 0){
    ...
    13ec:	a38a0a13          	addi	s4,s4,-1480 # 5e20 <malloc+0x176>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	260a8a93          	addi	s5,s5,608 # 6650 <malloc+0x9a6>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	1c050513          	addi	a0,a0,448 # 6620 <malloc+0x976>
    1468:	00004097          	auipc	ra,0x4
    146c:	78a080e7          	jalr	1930(ra) # 5bf2 <printf>
    exit(1);
    1470:	4505                	li	a0,1
    ...
    1480:	1bc50513          	addi	a0,a0,444 # 6638 <malloc+0x98e>
    1484:	00004097          	auipc	ra,0x4
    1488:	76e080e7          	jalr	1902(ra) # 5bf2 <printf>
        exit(1);
    148c:	4505                	li	a0,1
    ...
    149e:	1c650513          	addi	a0,a0,454 # 6660 <malloc+0x9b6>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	750080e7          	jalr	1872(ra) # 5bf2 <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	968a0a13          	addi	s4,s4,-1688 # 5e20 <malloc+0x176>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	1c0a8a93          	addi	s5,s5,448 # 6680 <malloc+0x9d6>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	91650513          	addi	a0,a0,-1770 # 5e20 <malloc+0x176>
  ...
  exit(xstatus);
    ...
    152c:	11050513          	addi	a0,a0,272 # 6638 <malloc+0x98e>
    1530:	00004097          	auipc	ra,0x4
    1534:	6c2080e7          	jalr	1730(ra) # 5bf2 <printf>
      exit(1);
    1538:	4505                	li	a0,1
    ...
    154a:	14250513          	addi	a0,a0,322 # 6688 <malloc+0x9de>
    154e:	00004097          	auipc	ra,0x4
    1552:	6a4080e7          	jalr	1700(ra) # 5bf2 <printf>
      exit(1);
    1556:	4505                	li	a0,1
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	85a78793          	addi	a5,a5,-1958 # 5dc8 <malloc+0x11e>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	12e78793          	addi	a5,a5,302 # 66a8 <malloc+0x9fe>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	12650513          	addi	a0,a0,294 # 66b0 <malloc+0xa06>
  ...
  if(pid == 0) {
    ...
    15bc:	0f850513          	addi	a0,a0,248 # 66b0 <malloc+0xa06>
    ...
    15d8:	0fc50513          	addi	a0,a0,252 # 66d0 <malloc+0xa26>
    15dc:	00004097          	auipc	ra,0x4
    15e0:	616080e7          	jalr	1558(ra) # 5bf2 <printf>
      exit(1);
    15e4:	4505                	li	a0,1
    ...
    15f4:	03050513          	addi	a0,a0,48 # 6620 <malloc+0x976>
    15f8:	00004097          	auipc	ra,0x4
    15fc:	5fa080e7          	jalr	1530(ra) # 5bf2 <printf>
     exit(1);
    1600:	4505                	li	a0,1
    ...
    1610:	0ac50513          	addi	a0,a0,172 # 66b8 <malloc+0xa0e>
    1614:	00004097          	auipc	ra,0x4
    1618:	5de080e7          	jalr	1502(ra) # 5bf2 <printf>
      exit(1);
    161c:	4505                	li	a0,1
    ...
    162e:	79e50513          	addi	a0,a0,1950 # 5dc8 <malloc+0x11e>
  ...
  if(xstatus != 0)
    ...
    1662:	08250513          	addi	a0,a0,130 # 66e0 <malloc+0xa36>
    1666:	00004097          	auipc	ra,0x4
    166a:	58c080e7          	jalr	1420(ra) # 5bf2 <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    167e:	07e50513          	addi	a0,a0,126 # 66f8 <malloc+0xa4e>
    1682:	00004097          	auipc	ra,0x4
    1686:	570080e7          	jalr	1392(ra) # 5bf2 <printf>
    168a:	b7d1                	j	164e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168c:	4581                	li	a1,0
    168e:	00005517          	auipc	a0,0x5
    1692:	02250513          	addi	a0,a0,34 # 66b0 <malloc+0xa06>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	ab050513          	addi	a0,a0,-1360 # 6168 <malloc+0x4be>
    16c0:	00004097          	auipc	ra,0x4
    16c4:	532080e7          	jalr	1330(ra) # 5bf2 <printf>
    exit(1);
    16c8:	4505                	li	a0,1
    ...
    16d8:	f6450513          	addi	a0,a0,-156 # 6638 <malloc+0x98e>
    16dc:	00004097          	auipc	ra,0x4
    16e0:	516080e7          	jalr	1302(ra) # 5bf2 <printf>
    exit(1);
    16e4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f2:	fc250513          	addi	a0,a0,-62 # 66b0 <malloc+0xa06>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	ff850513          	addi	a0,a0,-8 # 6710 <malloc+0xa66>
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17dc:	f5050513          	addi	a0,a0,-176 # 6728 <malloc+0xa7e>
    17e0:	00004097          	auipc	ra,0x4
    17e4:	412080e7          	jalr	1042(ra) # 5bf2 <printf>
    exit(1);
    17e8:	4505                	li	a0,1
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	ee250513          	addi	a0,a0,-286 # 6740 <malloc+0xa96>
    1866:	00004097          	auipc	ra,0x4
    186a:	38c080e7          	jalr	908(ra) # 5bf2 <printf>
        exit(1);
    186e:	4505                	li	a0,1
    ...
    187e:	ede50513          	addi	a0,a0,-290 # 6758 <malloc+0xaae>
    1882:	00004097          	auipc	ra,0x4
    1886:	370080e7          	jalr	880(ra) # 5bf2 <printf>
}
    ...
    18b0:	ec450513          	addi	a0,a0,-316 # 6770 <malloc+0xac6>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	33e080e7          	jalr	830(ra) # 5bf2 <printf>
      exit(1);
    18bc:	4505                	li	a0,1
    ...
    18f0:	ea450513          	addi	a0,a0,-348 # 6790 <malloc+0xae6>
    18f4:	00004097          	auipc	ra,0x4
    18f8:	2fe080e7          	jalr	766(ra) # 5bf2 <printf>
    exit(1);
    18fc:	4505                	li	a0,1
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	cc250513          	addi	a0,a0,-830 # 6620 <malloc+0x976>
    1966:	00004097          	auipc	ra,0x4
    196a:	28c080e7          	jalr	652(ra) # 5bf2 <printf>
      exit(1);
    196e:	4505                	li	a0,1
    ...
    197e:	e2e50513          	addi	a0,a0,-466 # 67a8 <malloc+0xafe>
    1982:	00004097          	auipc	ra,0x4
    1986:	270080e7          	jalr	624(ra) # 5bf2 <printf>
        exit(1);
    198a:	4505                	li	a0,1
    ...
    199a:	e2a50513          	addi	a0,a0,-470 # 67c0 <malloc+0xb16>
    199e:	00004097          	auipc	ra,0x4
    19a2:	254080e7          	jalr	596(ra) # 5bf2 <printf>
        exit(1);
    19a6:	4505                	li	a0,1
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	c1250513          	addi	a0,a0,-1006 # 6620 <malloc+0x976>
    1a16:	00004097          	auipc	ra,0x4
    1a1a:	1dc080e7          	jalr	476(ra) # 5bf2 <printf>
      exit(1);
    1a1e:	4505                	li	a0,1
    ...
    1a36:	bee50513          	addi	a0,a0,-1042 # 6620 <malloc+0x976>
    1a3a:	00004097          	auipc	ra,0x4
    1a3e:	1b8080e7          	jalr	440(ra) # 5bf2 <printf>
        exit(1);
    1a42:	4505                	li	a0,1
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	d3450513          	addi	a0,a0,-716 # 67e0 <malloc+0xb36>
    1ab4:	00004097          	auipc	ra,0x4
    1ab8:	13e080e7          	jalr	318(ra) # 5bf2 <printf>
      exit(1);
    1abc:	4505                	li	a0,1
    ...
    1ac2:	d9a080e7          	jalr	-614(ra) # 5858 <exit>
{
    ...
    1b08:	cec50513          	addi	a0,a0,-788 # 67f0 <malloc+0xb46>
    1b0c:	00004097          	auipc	ra,0x4
    1b10:	0e6080e7          	jalr	230(ra) # 5bf2 <printf>
      exit(1);
    1b14:	4505                	li	a0,1
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	eee50513          	addi	a0,a0,-274 # 6a40 <malloc+0xd96>
    1b5a:	00004097          	auipc	ra,0x4
    1b5e:	098080e7          	jalr	152(ra) # 5bf2 <printf>
      exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	e5050513          	addi	a0,a0,-432 # 6a40 <malloc+0xd96>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	ffa080e7          	jalr	-6(ra) # 5bf2 <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c20:	a9c50513          	addi	a0,a0,-1380 # 66b8 <malloc+0xa0e>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	fce080e7          	jalr	-50(ra) # 5bf2 <printf>
          exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c92:	b8250513          	addi	a0,a0,-1150 # 6810 <malloc+0xb66>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	f5c080e7          	jalr	-164(ra) # 5bf2 <printf>
            exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1cc6:	b6650513          	addi	a0,a0,-1178 # 6828 <malloc+0xb7e>
    1cca:	00004097          	auipc	ra,0x4
    1cce:	f28080e7          	jalr	-216(ra) # 5bf2 <printf>
        exit(1);
    1cd2:	4505                	li	a0,1
    ...
    1d2c:	b2850513          	addi	a0,a0,-1240 # 6850 <malloc+0xba6>
    1d30:	00004097          	auipc	ra,0x4
    1d34:	ec2080e7          	jalr	-318(ra) # 5bf2 <printf>
        exit(1);
    1d38:	4505                	li	a0,1
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	07050513          	addi	a0,a0,112 # 5e38 <malloc+0x18e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e08:	034a8a93          	addi	s5,s5,52 # 5e38 <malloc+0x18e>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	a6cb8b93          	addi	s7,s7,-1428 # 6878 <malloc+0xbce>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00005517          	auipc	a0,0x5
    1e1c:	80850513          	addi	a0,a0,-2040 # 6620 <malloc+0x976>
    1e20:	00004097          	auipc	ra,0x4
    1e24:	dd2080e7          	jalr	-558(ra) # 5bf2 <printf>
    exit(1);
    1e28:	4505                	li	a0,1
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	b3a50513          	addi	a0,a0,-1222 # 6a40 <malloc+0xd96>
    1f0e:	00004097          	auipc	ra,0x4
    1f12:	ce4080e7          	jalr	-796(ra) # 5bf2 <printf>
      exit(1);
    1f16:	4505                	li	a0,1
    ...
    1fba:	8ca50513          	addi	a0,a0,-1846 # 6880 <malloc+0xbd6>
    1fbe:	00004097          	auipc	ra,0x4
    1fc2:	c34080e7          	jalr	-972(ra) # 5bf2 <printf>
            exit(1);
    1fc6:	4505                	li	a0,1
    ...
    1fda:	ec250513          	addi	a0,a0,-318 # 5e98 <malloc+0x1ee>
    1fde:	00004097          	auipc	ra,0x4
    1fe2:	c14080e7          	jalr	-1004(ra) # 5bf2 <printf>
            exit(1);
    1fe6:	4505                	li	a0,1
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	88c50513          	addi	a0,a0,-1908 # 68b0 <malloc+0xc06>
    202c:	00004097          	auipc	ra,0x4
    2030:	bc6080e7          	jalr	-1082(ra) # 5bf2 <printf>
    exit(1);
    2034:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208a:	81250513          	addi	a0,a0,-2030 # 6898 <malloc+0xbee>
    208e:	00004097          	auipc	ra,0x4
    2092:	b64080e7          	jalr	-1180(ra) # 5bf2 <printf>
    exit(1);
    2096:	4505                	li	a0,1
    ...
    20a6:	83650513          	addi	a0,a0,-1994 # 68d8 <malloc+0xc2e>
    20aa:	00004097          	auipc	ra,0x4
    20ae:	b48080e7          	jalr	-1208(ra) # 5bf2 <printf>
      exit(1);
    20b2:	4505                	li	a0,1
    ...
    20c2:	83250513          	addi	a0,a0,-1998 # 68f0 <malloc+0xc46>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	b2c080e7          	jalr	-1236(ra) # 5bf2 <printf>
    exit(1);
    20ce:	4505                	li	a0,1
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	4e250513          	addi	a0,a0,1250 # 6620 <malloc+0x976>
    2146:	00004097          	auipc	ra,0x4
    214a:	aac080e7          	jalr	-1364(ra) # 5bf2 <printf>
      exit(1);
    214e:	4505                	li	a0,1
    ...
    2164:	7a850513          	addi	a0,a0,1960 # 6908 <malloc+0xc5e>
    2168:	00004097          	auipc	ra,0x4
    216c:	a8a080e7          	jalr	-1398(ra) # 5bf2 <printf>
      exit(1);
    2170:	4505                	li	a0,1
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	43e50513          	addi	a0,a0,1086 # 6620 <malloc+0x976>
    21ea:	00004097          	auipc	ra,0x4
    21ee:	a08080e7          	jalr	-1528(ra) # 5bf2 <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2212:	71a50513          	addi	a0,a0,1818 # 6928 <malloc+0xc7e>
    2216:	00004097          	auipc	ra,0x4
    221a:	9dc080e7          	jalr	-1572(ra) # 5bf2 <printf>
      exit(1);
    221e:	4505                	li	a0,1
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	70250513          	addi	a0,a0,1794 # 6940 <malloc+0xc96>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	6d050513          	addi	a0,a0,1744 # 6940 <malloc+0xc96>
  ...
  close(fd);
    ...
    22aa:	6aa70713          	addi	a4,a4,1706 # 6950 <malloc+0xca6>
    ...
    22fe:	73650513          	addi	a0,a0,1846 # 6a30 <malloc+0xd86>
    2302:	00004097          	auipc	ra,0x4
    2306:	8f0080e7          	jalr	-1808(ra) # 5bf2 <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    2322:	73250513          	addi	a0,a0,1842 # 6a50 <malloc+0xda6>
    2326:	00004097          	auipc	ra,0x4
    232a:	8cc080e7          	jalr	-1844(ra) # 5bf2 <printf>
    exit(1);
    232e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2380:	6f450513          	addi	a0,a0,1780 # 6a70 <malloc+0xdc6>
    2384:	00004097          	auipc	ra,0x4
    2388:	86e080e7          	jalr	-1938(ra) # 5bf2 <printf>
    exit(1);
    238c:	4505                	li	a0,1
    ...
    239c:	28850513          	addi	a0,a0,648 # 6620 <malloc+0x976>
    23a0:	00004097          	auipc	ra,0x4
    23a4:	852080e7          	jalr	-1966(ra) # 5bf2 <printf>
    exit(1);
    23a8:	4505                	li	a0,1
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	2e678793          	addi	a5,a5,742 # 7718 <malloc+0x1a6e>
  ...
  if(ret != -1){
    ...
    2478:	62450513          	addi	a0,a0,1572 # 6a98 <malloc+0xdee>
    247c:	00003097          	auipc	ra,0x3
    2480:	776080e7          	jalr	1910(ra) # 5bf2 <printf>
    exit(1);
    2484:	4505                	li	a0,1
    ...
    2496:	0ae50513          	addi	a0,a0,174 # 6540 <malloc+0x896>
    249a:	00003097          	auipc	ra,0x3
    249e:	758080e7          	jalr	1880(ra) # 5bf2 <printf>
    exit(1);
    24a2:	4505                	li	a0,1
    ...
    24b4:	0b050513          	addi	a0,a0,176 # 6560 <malloc+0x8b6>
    24b8:	00003097          	auipc	ra,0x3
    24bc:	73a080e7          	jalr	1850(ra) # 5bf2 <printf>
    exit(1);
    24c0:	4505                	li	a0,1
    ...
    24d4:	0b050513          	addi	a0,a0,176 # 6580 <malloc+0x8d6>
    24d8:	00003097          	auipc	ra,0x3
    24dc:	71a080e7          	jalr	1818(ra) # 5bf2 <printf>
    exit(1);
    24e0:	4505                	li	a0,1
    ...
    24f2:	0ba50513          	addi	a0,a0,186 # 65a8 <malloc+0x8fe>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	6fc080e7          	jalr	1788(ra) # 5bf2 <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	59e50513          	addi	a0,a0,1438 # 6ad8 <malloc+0xe2e>
  ...
  if(n >= 0){
    ...
    256e:	58e50513          	addi	a0,a0,1422 # 6af8 <malloc+0xe4e>
    2572:	00003097          	auipc	ra,0x3
    2576:	680080e7          	jalr	1664(ra) # 5bf2 <printf>
    exit(1);
    257a:	4505                	li	a0,1
    ...
    2588:	51c50513          	addi	a0,a0,1308 # 6aa0 <malloc+0xdf6>
    258c:	00003097          	auipc	ra,0x3
    2590:	666080e7          	jalr	1638(ra) # 5bf2 <printf>
    exit(1);
    2594:	4505                	li	a0,1
    ...
    25a2:	51a50513          	addi	a0,a0,1306 # 6ab8 <malloc+0xe0e>
    25a6:	00003097          	auipc	ra,0x3
    25aa:	64c080e7          	jalr	1612(ra) # 5bf2 <printf>
    exit(1);
    25ae:	4505                	li	a0,1
    ...
    25bc:	52850513          	addi	a0,a0,1320 # 6ae0 <malloc+0xe36>
    25c0:	00003097          	auipc	ra,0x3
    25c4:	632080e7          	jalr	1586(ra) # 5bf2 <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e0:	4fc50513          	addi	a0,a0,1276 # 6ad8 <malloc+0xe2e>
    25e4:	00003097          	auipc	ra,0x3
    25e8:	2c4080e7          	jalr	708(ra) # 58a8 <unlink>
  fd = open("README", O_RDONLY);
    25ec:	4581                	li	a1,0
    25ee:	00004517          	auipc	a0,0x4
    25f2:	98250513          	addi	a0,a0,-1662 # 5f70 <malloc+0x2c6>
  ...
  if(n >= 0){
    ...
    261c:	51050513          	addi	a0,a0,1296 # 6b28 <malloc+0xe7e>
    2620:	00003097          	auipc	ra,0x3
    2624:	5d2080e7          	jalr	1490(ra) # 5bf2 <printf>
    exit(1);
    2628:	4505                	li	a0,1
    ...
    2636:	4ae50513          	addi	a0,a0,1198 # 6ae0 <malloc+0xe36>
    263a:	00003097          	auipc	ra,0x3
    263e:	5b8080e7          	jalr	1464(ra) # 5bf2 <printf>
    exit(1);
    2642:	4505                	li	a0,1
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26b6:	49e50513          	addi	a0,a0,1182 # 6b50 <malloc+0xea6>
    26ba:	00003097          	auipc	ra,0x3
    26be:	538080e7          	jalr	1336(ra) # 5bf2 <printf>
    exit(1);
    26c2:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	46c50513          	addi	a0,a0,1132 # 6b70 <malloc+0xec6>
    270c:	00003097          	auipc	ra,0x3
    2710:	4e6080e7          	jalr	1254(ra) # 5bf2 <printf>
    exit(1);
    2714:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    276c:	46850513          	addi	a0,a0,1128 # 6bd0 <malloc+0xf26>
    2770:	00003097          	auipc	ra,0x3
    2774:	482080e7          	jalr	1154(ra) # 5bf2 <printf>
    exit(1);
    2778:	4505                	li	a0,1
    ...
    278e:	40650513          	addi	a0,a0,1030 # 6b90 <malloc+0xee6>
    2792:	00003097          	auipc	ra,0x3
    2796:	460080e7          	jalr	1120(ra) # 5bf2 <printf>
      exit(1);
    279a:	4505                	li	a0,1
    ...
    27aa:	40a50513          	addi	a0,a0,1034 # 6bb0 <malloc+0xf06>
    27ae:	00003097          	auipc	ra,0x3
    27b2:	444080e7          	jalr	1092(ra) # 5bf2 <printf>
    exit(1);
    27b6:	4505                	li	a0,1
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    28f4:	30050513          	addi	a0,a0,768 # 6bf0 <malloc+0xf46>
    28f8:	00003097          	auipc	ra,0x3
    28fc:	2fa080e7          	jalr	762(ra) # 5bf2 <printf>
    exit(1);
    2900:	4505                	li	a0,1
    ...
    2910:	32c50513          	addi	a0,a0,812 # 6c38 <malloc+0xf8e>
    2914:	00003097          	auipc	ra,0x3
    2918:	2de080e7          	jalr	734(ra) # 5bf2 <printf>
    exit(1);
    291c:	4505                	li	a0,1
    ...
    2930:	32c50513          	addi	a0,a0,812 # 6c58 <malloc+0xfae>
    2934:	00003097          	auipc	ra,0x3
    2938:	2be080e7          	jalr	702(ra) # 5bf2 <printf>
    exit(1);
    293c:	4505                	li	a0,1
    ...
    2950:	34c50513          	addi	a0,a0,844 # 6c98 <malloc+0xfee>
    2954:	00003097          	auipc	ra,0x3
    2958:	29e080e7          	jalr	670(ra) # 5bf2 <printf>
    exit(1);
    295c:	4505                	li	a0,1
    ...
    296c:	36050513          	addi	a0,a0,864 # 6cc8 <malloc+0x101e>
    2970:	00003097          	auipc	ra,0x3
    2974:	282080e7          	jalr	642(ra) # 5bf2 <printf>
    exit(1);
    2978:	4505                	li	a0,1
    ...
    298c:	37850513          	addi	a0,a0,888 # 6d00 <malloc+0x1056>
    2990:	00003097          	auipc	ra,0x3
    2994:	262080e7          	jalr	610(ra) # 5bf2 <printf>
    exit(1);
    2998:	4505                	li	a0,1
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	36650513          	addi	a0,a0,870 # 6d28 <malloc+0x107e>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	ece080e7          	jalr	-306(ra) # 5898 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	35450513          	addi	a0,a0,852 # 6d28 <malloc+0x107e>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	30850513          	addi	a0,a0,776 # 6d30 <malloc+0x1086>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	1c2080e7          	jalr	450(ra) # 5bf2 <printf>
    exit(1);
    2a38:	4505                	li	a0,1
    ...
    2a48:	30450513          	addi	a0,a0,772 # 6d48 <malloc+0x109e>
    2a4c:	00003097          	auipc	ra,0x3
    2a50:	1a6080e7          	jalr	422(ra) # 5bf2 <printf>
    exit(1);
    2a54:	4505                	li	a0,1
    ...
    2a64:	cc850513          	addi	a0,a0,-824 # 6728 <malloc+0xa7e>
    2a68:	00003097          	auipc	ra,0x3
    2a6c:	18a080e7          	jalr	394(ra) # 5bf2 <printf>
    exit(1);
    2a70:	4505                	li	a0,1
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	2d650513          	addi	a0,a0,726 # 6d60 <malloc+0x10b6>
  ...
  close(fd);
    ...
    2ad6:	b6650513          	addi	a0,a0,-1178 # 6638 <malloc+0x98e>
    2ada:	00003097          	auipc	ra,0x3
    2ade:	118080e7          	jalr	280(ra) # 5bf2 <printf>
    exit(1);
    2ae2:	4505                	li	a0,1
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	f2050513          	addi	a0,a0,-224 # 6a40 <malloc+0xd96>
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	0ca080e7          	jalr	202(ra) # 5bf2 <printf>
    exit(1);
    2b30:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b7a:	eca50513          	addi	a0,a0,-310 # 6a40 <malloc+0xd96>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	074080e7          	jalr	116(ra) # 5bf2 <printf>
    exit(1);
    2b86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bda:	e6a50513          	addi	a0,a0,-406 # 6a40 <malloc+0xd96>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	014080e7          	jalr	20(ra) # 5bf2 <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	cf650513          	addi	a0,a0,-778 # 6a40 <malloc+0xd96>
    2d52:	00003097          	auipc	ra,0x3
    2d56:	ea0080e7          	jalr	-352(ra) # 5bf2 <printf>
      exit(1);
    2d5a:	4505                	li	a0,1
    ...
    2da2:	02a50513          	addi	a0,a0,42 # 5dc8 <malloc+0x11e>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	08e78793          	addi	a5,a5,142 # 5e38 <malloc+0x18e>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	15c50513          	addi	a0,a0,348 # 6f38 <malloc+0x128e>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	fa250513          	addi	a0,a0,-94 # 6d90 <malloc+0x10e6>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	fe450513          	addi	a0,a0,-28 # 6de8 <malloc+0x113e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	03e50513          	addi	a0,a0,62 # 6e60 <malloc+0x11b6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	09250513          	addi	a0,a0,146 # 6ed0 <malloc+0x1226>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	0d850513          	addi	a0,a0,216 # 6f28 <malloc+0x127e>
  ...
  unlink("12345678901234");
    ...
    2ed2:	e9a50513          	addi	a0,a0,-358 # 6d68 <malloc+0x10be>
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	d1c080e7          	jalr	-740(ra) # 5bf2 <printf>
    exit(1);
    2ede:	4505                	li	a0,1
    ...
    2eee:	ec650513          	addi	a0,a0,-314 # 6db0 <malloc+0x1106>
    2ef2:	00003097          	auipc	ra,0x3
    2ef6:	d00080e7          	jalr	-768(ra) # 5bf2 <printf>
    exit(1);
    2efa:	4505                	li	a0,1
    ...
    2f0a:	f1250513          	addi	a0,a0,-238 # 6e18 <malloc+0x116e>
    2f0e:	00003097          	auipc	ra,0x3
    2f12:	ce4080e7          	jalr	-796(ra) # 5bf2 <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f26:	f6e50513          	addi	a0,a0,-146 # 6e90 <malloc+0x11e6>
    2f2a:	00003097          	auipc	ra,0x3
    2f2e:	cc8080e7          	jalr	-824(ra) # 5bf2 <printf>
    exit(1);
    2f32:	4505                	li	a0,1
    ...
    2f42:	fb250513          	addi	a0,a0,-78 # 6ef0 <malloc+0x1246>
    2f46:	00003097          	auipc	ra,0x3
    2f4a:	cac080e7          	jalr	-852(ra) # 5bf2 <printf>
    exit(1);
    2f4e:	4505                	li	a0,1
    ...
    2f5e:	fee50513          	addi	a0,a0,-18 # 6f48 <malloc+0x129e>
    2f62:	00003097          	auipc	ra,0x3
    2f66:	c90080e7          	jalr	-880(ra) # 5bf2 <printf>
    exit(1);
    2f6a:	4505                	li	a0,1
...
0000000000002f74 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	fec50513          	addi	a0,a0,-20 # 6f80 <malloc+0x12d6>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fac:	01850513          	addi	a0,a0,24 # 6fc0 <malloc+0x1316>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	03450513          	addi	a0,a0,52 # 6ff0 <malloc+0x1346>
    ...
    2fe0:	fac50513          	addi	a0,a0,-84 # 6f88 <malloc+0x12de>
    2fe4:	00003097          	auipc	ra,0x3
    2fe8:	c0e080e7          	jalr	-1010(ra) # 5bf2 <printf>
    exit(1);
    2fec:	4505                	li	a0,1
    ...
    2ffc:	fa850513          	addi	a0,a0,-88 # 6fa0 <malloc+0x12f6>
    3000:	00003097          	auipc	ra,0x3
    3004:	bf2080e7          	jalr	-1038(ra) # 5bf2 <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3018:	fbc50513          	addi	a0,a0,-68 # 6fd0 <malloc+0x1326>
    301c:	00003097          	auipc	ra,0x3
    3020:	bd6080e7          	jalr	-1066(ra) # 5bf2 <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	fc850513          	addi	a0,a0,-56 # 6ff8 <malloc+0x134e>
    3038:	00003097          	auipc	ra,0x3
    303c:	bba080e7          	jalr	-1094(ra) # 5bf2 <printf>
    exit(1);
    3040:	4505                	li	a0,1
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	f1c50513          	addi	a0,a0,-228 # 6f80 <malloc+0x12d6>
    ...
    307c:	f0850513          	addi	a0,a0,-248 # 6f80 <malloc+0x12d6>
    ...
    3090:	f3450513          	addi	a0,a0,-204 # 6fc0 <malloc+0x1316>
    ...
    30b0:	57450513          	addi	a0,a0,1396 # 6620 <malloc+0x976>
    30b4:	00003097          	auipc	ra,0x3
    30b8:	b3e080e7          	jalr	-1218(ra) # 5bf2 <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30cc:	ec050513          	addi	a0,a0,-320 # 6f88 <malloc+0x12de>
    30d0:	00003097          	auipc	ra,0x3
    30d4:	b22080e7          	jalr	-1246(ra) # 5bf2 <printf>
      exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e8:	f2c50513          	addi	a0,a0,-212 # 7010 <malloc+0x1366>
    30ec:	00003097          	auipc	ra,0x3
    30f0:	b06080e7          	jalr	-1274(ra) # 5bf2 <printf>
      exit(1);
    30f4:	4505                	li	a0,1
    ...
    3104:	ed050513          	addi	a0,a0,-304 # 6fd0 <malloc+0x1326>
    3108:	00003097          	auipc	ra,0x3
    310c:	aea080e7          	jalr	-1302(ra) # 5bf2 <printf>
      exit(1);
    3110:	4505                	li	a0,1
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	eea50513          	addi	a0,a0,-278 # 7028 <malloc+0x137e>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	ed650513          	addi	a0,a0,-298 # 7028 <malloc+0x137e>
  ...
  if(chdir("..") < 0){
    ...
    316a:	ee250513          	addi	a0,a0,-286 # 7048 <malloc+0x139e>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	eae50513          	addi	a0,a0,-338 # 7028 <malloc+0x137e>
    ...
    319e:	dee50513          	addi	a0,a0,-530 # 6f88 <malloc+0x12de>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	a50080e7          	jalr	-1456(ra) # 5bf2 <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	e7a50513          	addi	a0,a0,-390 # 7030 <malloc+0x1386>
    31be:	00003097          	auipc	ra,0x3
    31c2:	a34080e7          	jalr	-1484(ra) # 5bf2 <printf>
    exit(1);
    31c6:	4505                	li	a0,1
    ...
    31d6:	e7e50513          	addi	a0,a0,-386 # 7050 <malloc+0x13a6>
    31da:	00003097          	auipc	ra,0x3
    31de:	a18080e7          	jalr	-1512(ra) # 5bf2 <printf>
    exit(1);
    31e2:	4505                	li	a0,1
    ...
    31f2:	e7a50513          	addi	a0,a0,-390 # 7068 <malloc+0x13be>
    31f6:	00003097          	auipc	ra,0x3
    31fa:	9fc080e7          	jalr	-1540(ra) # 5bf2 <printf>
    exit(1);
    31fe:	4505                	li	a0,1
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	f9a50513          	addi	a0,a0,-102 # 71b0 <malloc+0x1506>
    321e:	00002097          	auipc	ra,0x2
    3222:	68a080e7          	jalr	1674(ra) # 58a8 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	e5a50513          	addi	a0,a0,-422 # 7080 <malloc+0x13d6>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	e6250513          	addi	a0,a0,-414 # 70a0 <malloc+0x13f6>
  ...
  write(fd, "ff", 2);
    ...
    325a:	f5a58593          	addi	a1,a1,-166 # 71b0 <malloc+0x1506>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	e1050513          	addi	a0,a0,-496 # 7080 <malloc+0x13d6>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	e7450513          	addi	a0,a0,-396 # 70f8 <malloc+0x144e>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e8450513          	addi	a0,a0,-380 # 7120 <malloc+0x1476>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	e9c58593          	addi	a1,a1,-356 # 7150 <malloc+0x14a6>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	e8850513          	addi	a0,a0,-376 # 7158 <malloc+0x14ae>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	e9058593          	addi	a1,a1,-368 # 71a8 <malloc+0x14fe>
    3320:	00004517          	auipc	a0,0x4
    3324:	e0050513          	addi	a0,a0,-512 # 7120 <malloc+0x1476>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	dec50513          	addi	a0,a0,-532 # 7120 <malloc+0x1476>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	dd650513          	addi	a0,a0,-554 # 7120 <malloc+0x1476>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	d2250513          	addi	a0,a0,-734 # 7080 <malloc+0x13d6>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	ece50513          	addi	a0,a0,-306 # 7240 <malloc+0x1596>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	eea50513          	addi	a0,a0,-278 # 7270 <malloc+0x15c6>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	f0650513          	addi	a0,a0,-250 # 72a0 <malloc+0x15f6>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	df850513          	addi	a0,a0,-520 # 71a8 <malloc+0x14fe>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	d3650513          	addi	a0,a0,-714 # 7120 <malloc+0x1476>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	f2e50513          	addi	a0,a0,-210 # 7330 <malloc+0x1686>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	f4650513          	addi	a0,a0,-186 # 7360 <malloc+0x16b6>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	c4e50513          	addi	a0,a0,-946 # 7080 <malloc+0x13d6>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	c3850513          	addi	a0,a0,-968 # 7080 <malloc+0x13d6>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	c2250513          	addi	a0,a0,-990 # 7080 <malloc+0x13d6>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	f7e58593          	addi	a1,a1,-130 # 73f0 <malloc+0x1746>
    347a:	00004517          	auipc	a0,0x4
    347e:	eb650513          	addi	a0,a0,-330 # 7330 <malloc+0x1686>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	f6258593          	addi	a1,a1,-158 # 73f0 <malloc+0x1746>
    3496:	00004517          	auipc	a0,0x4
    349a:	eca50513          	addi	a0,a0,-310 # 7360 <malloc+0x16b6>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	cfe58593          	addi	a1,a1,-770 # 71a8 <malloc+0x14fe>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	bee50513          	addi	a0,a0,-1042 # 70a0 <malloc+0x13f6>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	e6a50513          	addi	a0,a0,-406 # 7330 <malloc+0x1686>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	e8650513          	addi	a0,a0,-378 # 7360 <malloc+0x16b6>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	cba50513          	addi	a0,a0,-838 # 71a8 <malloc+0x14fe>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	e5e50513          	addi	a0,a0,-418 # 7360 <malloc+0x16b6>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	e1a50513          	addi	a0,a0,-486 # 7330 <malloc+0x1686>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	b7650513          	addi	a0,a0,-1162 # 70a0 <malloc+0x13f6>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	00250513          	addi	a0,a0,2 # 7540 <malloc+0x1896>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	c5650513          	addi	a0,a0,-938 # 71a8 <malloc+0x14fe>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	b3a50513          	addi	a0,a0,-1222 # 70a0 <malloc+0x13f6>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	b0650513          	addi	a0,a0,-1274 # 7080 <malloc+0x13d6>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	02250513          	addi	a0,a0,34 # 75b0 <malloc+0x1906>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	ade50513          	addi	a0,a0,-1314 # 7080 <malloc+0x13d6>
    ...
    35c8:	ac450513          	addi	a0,a0,-1340 # 7088 <malloc+0x13de>
    35cc:	00002097          	auipc	ra,0x2
    35d0:	626080e7          	jalr	1574(ra) # 5bf2 <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e4:	ac850513          	addi	a0,a0,-1336 # 70a8 <malloc+0x13fe>
    35e8:	00002097          	auipc	ra,0x2
    35ec:	60a080e7          	jalr	1546(ra) # 5bf2 <printf>
    exit(1);
    35f0:	4505                	li	a0,1
    ...
    3600:	acc50513          	addi	a0,a0,-1332 # 70c8 <malloc+0x141e>
    3604:	00002097          	auipc	ra,0x2
    3608:	5ee080e7          	jalr	1518(ra) # 5bf2 <printf>
    exit(1);
    360c:	4505                	li	a0,1
    ...
    361c:	ae850513          	addi	a0,a0,-1304 # 7100 <malloc+0x1456>
    3620:	00002097          	auipc	ra,0x2
    3624:	5d2080e7          	jalr	1490(ra) # 5bf2 <printf>
    exit(1);
    3628:	4505                	li	a0,1
    ...
    3638:	afc50513          	addi	a0,a0,-1284 # 7130 <malloc+0x1486>
    363c:	00002097          	auipc	ra,0x2
    3640:	5b6080e7          	jalr	1462(ra) # 5bf2 <printf>
    exit(1);
    3644:	4505                	li	a0,1
    ...
    3654:	b1850513          	addi	a0,a0,-1256 # 7168 <malloc+0x14be>
    3658:	00002097          	auipc	ra,0x2
    365c:	59a080e7          	jalr	1434(ra) # 5bf2 <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    3670:	b1c50513          	addi	a0,a0,-1252 # 7188 <malloc+0x14de>
    3674:	00002097          	auipc	ra,0x2
    3678:	57e080e7          	jalr	1406(ra) # 5bf2 <printf>
    exit(1);
    367c:	4505                	li	a0,1
    ...
    368c:	b3050513          	addi	a0,a0,-1232 # 71b8 <malloc+0x150e>
    3690:	00002097          	auipc	ra,0x2
    3694:	562080e7          	jalr	1378(ra) # 5bf2 <printf>
    exit(1);
    3698:	4505                	li	a0,1
    ...
    36a8:	b3c50513          	addi	a0,a0,-1220 # 71e0 <malloc+0x1536>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	546080e7          	jalr	1350(ra) # 5bf2 <printf>
    exit(1);
    36b4:	4505                	li	a0,1
    ...
    36c4:	b4050513          	addi	a0,a0,-1216 # 7200 <malloc+0x1556>
    36c8:	00002097          	auipc	ra,0x2
    36cc:	52a080e7          	jalr	1322(ra) # 5bf2 <printf>
    exit(1);
    36d0:	4505                	li	a0,1
    ...
    36e0:	b4c50513          	addi	a0,a0,-1204 # 7228 <malloc+0x157e>
    36e4:	00002097          	auipc	ra,0x2
    36e8:	50e080e7          	jalr	1294(ra) # 5bf2 <printf>
    exit(1);
    36ec:	4505                	li	a0,1
    ...
    36fc:	b5850513          	addi	a0,a0,-1192 # 7250 <malloc+0x15a6>
    3700:	00002097          	auipc	ra,0x2
    3704:	4f2080e7          	jalr	1266(ra) # 5bf2 <printf>
    exit(1);
    3708:	4505                	li	a0,1
    ...
    3718:	b6c50513          	addi	a0,a0,-1172 # 7280 <malloc+0x15d6>
    371c:	00002097          	auipc	ra,0x2
    3720:	4d6080e7          	jalr	1238(ra) # 5bf2 <printf>
    exit(1);
    3724:	4505                	li	a0,1
    ...
    3734:	b7850513          	addi	a0,a0,-1160 # 72a8 <malloc+0x15fe>
    3738:	00002097          	auipc	ra,0x2
    373c:	4ba080e7          	jalr	1210(ra) # 5bf2 <printf>
    exit(1);
    3740:	4505                	li	a0,1
    ...
    3750:	b7450513          	addi	a0,a0,-1164 # 72c0 <malloc+0x1616>
    3754:	00002097          	auipc	ra,0x2
    3758:	49e080e7          	jalr	1182(ra) # 5bf2 <printf>
    exit(1);
    375c:	4505                	li	a0,1
    ...
    376c:	b7850513          	addi	a0,a0,-1160 # 72e0 <malloc+0x1636>
    3770:	00002097          	auipc	ra,0x2
    3774:	482080e7          	jalr	1154(ra) # 5bf2 <printf>
    exit(1);
    3778:	4505                	li	a0,1
    ...
    3788:	b7c50513          	addi	a0,a0,-1156 # 7300 <malloc+0x1656>
    378c:	00002097          	auipc	ra,0x2
    3790:	466080e7          	jalr	1126(ra) # 5bf2 <printf>
    exit(1);
    3794:	4505                	li	a0,1
    ...
    37a4:	ba050513          	addi	a0,a0,-1120 # 7340 <malloc+0x1696>
    37a8:	00002097          	auipc	ra,0x2
    37ac:	44a080e7          	jalr	1098(ra) # 5bf2 <printf>
    exit(1);
    37b0:	4505                	li	a0,1
    ...
    37c0:	bb450513          	addi	a0,a0,-1100 # 7370 <malloc+0x16c6>
    37c4:	00002097          	auipc	ra,0x2
    37c8:	42e080e7          	jalr	1070(ra) # 5bf2 <printf>
    exit(1);
    37cc:	4505                	li	a0,1
    ...
    37dc:	bb850513          	addi	a0,a0,-1096 # 7390 <malloc+0x16e6>
    37e0:	00002097          	auipc	ra,0x2
    37e4:	412080e7          	jalr	1042(ra) # 5bf2 <printf>
    exit(1);
    37e8:	4505                	li	a0,1
    ...
    37f8:	bbc50513          	addi	a0,a0,-1092 # 73b0 <malloc+0x1706>
    37fc:	00002097          	auipc	ra,0x2
    3800:	3f6080e7          	jalr	1014(ra) # 5bf2 <printf>
    exit(1);
    3804:	4505                	li	a0,1
    ...
    3814:	bc050513          	addi	a0,a0,-1088 # 73d0 <malloc+0x1726>
    3818:	00002097          	auipc	ra,0x2
    381c:	3da080e7          	jalr	986(ra) # 5bf2 <printf>
    exit(1);
    3820:	4505                	li	a0,1
    ...
    3830:	bd450513          	addi	a0,a0,-1068 # 7400 <malloc+0x1756>
    3834:	00002097          	auipc	ra,0x2
    3838:	3be080e7          	jalr	958(ra) # 5bf2 <printf>
    exit(1);
    383c:	4505                	li	a0,1
    ...
    384c:	be050513          	addi	a0,a0,-1056 # 7428 <malloc+0x177e>
    3850:	00002097          	auipc	ra,0x2
    3854:	3a2080e7          	jalr	930(ra) # 5bf2 <printf>
    exit(1);
    3858:	4505                	li	a0,1
    ...
    3868:	bec50513          	addi	a0,a0,-1044 # 7450 <malloc+0x17a6>
    386c:	00002097          	auipc	ra,0x2
    3870:	386080e7          	jalr	902(ra) # 5bf2 <printf>
    exit(1);
    3874:	4505                	li	a0,1
    ...
    3884:	bf850513          	addi	a0,a0,-1032 # 7478 <malloc+0x17ce>
    3888:	00002097          	auipc	ra,0x2
    388c:	36a080e7          	jalr	874(ra) # 5bf2 <printf>
    exit(1);
    3890:	4505                	li	a0,1
    ...
    38a0:	bfc50513          	addi	a0,a0,-1028 # 7498 <malloc+0x17ee>
    38a4:	00002097          	auipc	ra,0x2
    38a8:	34e080e7          	jalr	846(ra) # 5bf2 <printf>
    exit(1);
    38ac:	4505                	li	a0,1
    ...
    38bc:	c0050513          	addi	a0,a0,-1024 # 74b8 <malloc+0x180e>
    38c0:	00002097          	auipc	ra,0x2
    38c4:	332080e7          	jalr	818(ra) # 5bf2 <printf>
    exit(1);
    38c8:	4505                	li	a0,1
    ...
    38d8:	c0c50513          	addi	a0,a0,-1012 # 74e0 <malloc+0x1836>
    38dc:	00002097          	auipc	ra,0x2
    38e0:	316080e7          	jalr	790(ra) # 5bf2 <printf>
    exit(1);
    38e4:	4505                	li	a0,1
    ...
    38f4:	c1050513          	addi	a0,a0,-1008 # 7500 <malloc+0x1856>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	2fa080e7          	jalr	762(ra) # 5bf2 <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	c1450513          	addi	a0,a0,-1004 # 7520 <malloc+0x1876>
    3914:	00002097          	auipc	ra,0x2
    3918:	2de080e7          	jalr	734(ra) # 5bf2 <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	c2050513          	addi	a0,a0,-992 # 7548 <malloc+0x189e>
    3930:	00002097          	auipc	ra,0x2
    3934:	2c2080e7          	jalr	706(ra) # 5bf2 <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	89c50513          	addi	a0,a0,-1892 # 71e0 <malloc+0x1536>
    394c:	00002097          	auipc	ra,0x2
    3950:	2a6080e7          	jalr	678(ra) # 5bf2 <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	c0850513          	addi	a0,a0,-1016 # 7568 <malloc+0x18be>
    3968:	00002097          	auipc	ra,0x2
    396c:	28a080e7          	jalr	650(ra) # 5bf2 <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	c0c50513          	addi	a0,a0,-1012 # 7588 <malloc+0x18de>
    ...
    399c:	c2050513          	addi	a0,a0,-992 # 75b8 <malloc+0x190e>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	252080e7          	jalr	594(ra) # 5bf2 <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	c2450513          	addi	a0,a0,-988 # 75d8 <malloc+0x192e>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	236080e7          	jalr	566(ra) # 5bf2 <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	c1650513          	addi	a0,a0,-1002 # 75f0 <malloc+0x1946>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	c0450513          	addi	a0,a0,-1020 # 75f0 <malloc+0x1946>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	a8250513          	addi	a0,a0,-1406 # 6480 <malloc+0x7d6>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	63850513          	addi	a0,a0,1592 # 7048 <malloc+0x139e>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	5ce50513          	addi	a0,a0,1486 # 6ff0 <malloc+0x1346>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	c2450513          	addi	a0,a0,-988 # 7658 <malloc+0x19ae>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	c3a50513          	addi	a0,a0,-966 # 7680 <malloc+0x19d6>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	b9850513          	addi	a0,a0,-1128 # 75f0 <malloc+0x1946>
    ...
    3a7a:	b8250513          	addi	a0,a0,-1150 # 75f8 <malloc+0x194e>
    3a7e:	00002097          	auipc	ra,0x2
    3a82:	174080e7          	jalr	372(ra) # 5bf2 <printf>
    exit(1);
    3a86:	4505                	li	a0,1
    ...
    3a96:	b7e50513          	addi	a0,a0,-1154 # 7610 <malloc+0x1966>
    3a9a:	00002097          	auipc	ra,0x2
    3a9e:	158080e7          	jalr	344(ra) # 5bf2 <printf>
    exit(1);
    3aa2:	4505                	li	a0,1
    ...
    3ab2:	b7a50513          	addi	a0,a0,-1158 # 7628 <malloc+0x197e>
    3ab6:	00002097          	auipc	ra,0x2
    3aba:	13c080e7          	jalr	316(ra) # 5bf2 <printf>
    exit(1);
    3abe:	4505                	li	a0,1
    ...
    3ace:	b7650513          	addi	a0,a0,-1162 # 7640 <malloc+0x1996>
    3ad2:	00002097          	auipc	ra,0x2
    3ad6:	120080e7          	jalr	288(ra) # 5bf2 <printf>
    exit(1);
    3ada:	4505                	li	a0,1
    ...
    3aea:	51250513          	addi	a0,a0,1298 # 6ff8 <malloc+0x134e>
    3aee:	00002097          	auipc	ra,0x2
    3af2:	104080e7          	jalr	260(ra) # 5bf2 <printf>
    exit(1);
    3af6:	4505                	li	a0,1
    ...
    3b06:	b5e50513          	addi	a0,a0,-1186 # 7660 <malloc+0x19b6>
    3b0a:	00002097          	auipc	ra,0x2
    3b0e:	0e8080e7          	jalr	232(ra) # 5bf2 <printf>
    exit(1);
    3b12:	4505                	li	a0,1
    ...
    3b22:	b6a50513          	addi	a0,a0,-1174 # 7688 <malloc+0x19de>
    3b26:	00002097          	auipc	ra,0x2
    3b2a:	0cc080e7          	jalr	204(ra) # 5bf2 <printf>
    exit(1);
    3b2e:	4505                	li	a0,1
    ...
    3b3e:	b6e50513          	addi	a0,a0,-1170 # 76a8 <malloc+0x19fe>
    3b42:	00002097          	auipc	ra,0x2
    3b46:	0b0080e7          	jalr	176(ra) # 5bf2 <printf>
    exit(1);
    3b4a:	4505                	li	a0,1
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	b6250513          	addi	a0,a0,-1182 # 76c8 <malloc+0x1a1e>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	b4650513          	addi	a0,a0,-1210 # 76c8 <malloc+0x1a1e>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	b7a50513          	addi	a0,a0,-1158 # 7710 <malloc+0x1a66>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	b6250513          	addi	a0,a0,-1182 # 7710 <malloc+0x1a66>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	b4e50513          	addi	a0,a0,-1202 # 7710 <malloc+0x1a66>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	b3a50513          	addi	a0,a0,-1222 # 7710 <malloc+0x1a66>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	b2658593          	addi	a1,a1,-1242 # 7710 <malloc+0x1a66>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	37e50513          	addi	a0,a0,894 # 5f70 <malloc+0x2c6>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	ac250513          	addi	a0,a0,-1342 # 76c8 <malloc+0x1a1e>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	86450513          	addi	a0,a0,-1948 # 6480 <malloc+0x7d6>
  ...
  fd = open(".", 0);
    ...
    3c36:	84e50513          	addi	a0,a0,-1970 # 6480 <malloc+0x7d6>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	1f258593          	addi	a1,a1,498 # 5e38 <malloc+0x18e>
  ...
  close(fd);
    ...
    3c76:	a5e50513          	addi	a0,a0,-1442 # 76d0 <malloc+0x1a26>
    3c7a:	00002097          	auipc	ra,0x2
    3c7e:	f78080e7          	jalr	-136(ra) # 5bf2 <printf>
    exit(1);
    3c82:	4505                	li	a0,1
    ...
    3c92:	a6250513          	addi	a0,a0,-1438 # 76f0 <malloc+0x1a46>
    3c96:	00002097          	auipc	ra,0x2
    3c9a:	f5c080e7          	jalr	-164(ra) # 5bf2 <printf>
    exit(1);
    3c9e:	4505                	li	a0,1
    ...
    3cae:	a7650513          	addi	a0,a0,-1418 # 7720 <malloc+0x1a76>
    3cb2:	00002097          	auipc	ra,0x2
    3cb6:	f40080e7          	jalr	-192(ra) # 5bf2 <printf>
    exit(1);
    3cba:	4505                	li	a0,1
    ...
    3cca:	a5a50513          	addi	a0,a0,-1446 # 7720 <malloc+0x1a76>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	f24080e7          	jalr	-220(ra) # 5bf2 <printf>
    exit(1);
    3cd6:	4505                	li	a0,1
    ...
    3ce6:	a6650513          	addi	a0,a0,-1434 # 7748 <malloc+0x1a9e>
    3cea:	00002097          	auipc	ra,0x2
    3cee:	f08080e7          	jalr	-248(ra) # 5bf2 <printf>
    exit(1);
    3cf2:	4505                	li	a0,1
    ...
    3d02:	a7250513          	addi	a0,a0,-1422 # 7770 <malloc+0x1ac6>
    3d06:	00002097          	auipc	ra,0x2
    3d0a:	eec080e7          	jalr	-276(ra) # 5bf2 <printf>
    exit(1);
    3d0e:	4505                	li	a0,1
    ...
    3d1e:	a7e50513          	addi	a0,a0,-1410 # 7798 <malloc+0x1aee>
    3d22:	00002097          	auipc	ra,0x2
    3d26:	ed0080e7          	jalr	-304(ra) # 5bf2 <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	a8a50513          	addi	a0,a0,-1398 # 77c0 <malloc+0x1b16>
    3d3e:	00002097          	auipc	ra,0x2
    3d42:	eb4080e7          	jalr	-332(ra) # 5bf2 <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	a8e50513          	addi	a0,a0,-1394 # 77e0 <malloc+0x1b36>
    3d5a:	00002097          	auipc	ra,0x2
    3d5e:	e98080e7          	jalr	-360(ra) # 5bf2 <printf>
    exit(1);
    3d62:	4505                	li	a0,1
    ...
    3d72:	a9a50513          	addi	a0,a0,-1382 # 7808 <malloc+0x1b5e>
    3d76:	00002097          	auipc	ra,0x2
    3d7a:	e7c080e7          	jalr	-388(ra) # 5bf2 <printf>
    exit(1);
    3d7e:	4505                	li	a0,1
...
0000000000003d88 <iref>:
{
    ...
    3da6:	a7ea0a13          	addi	s4,s4,-1410 # 7820 <malloc+0x1b76>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	57e48493          	addi	s1,s1,1406 # 7328 <malloc+0x167e>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	1bea8a93          	addi	s5,s5,446 # 5f70 <malloc+0x2c6>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	95e98993          	addi	s3,s3,-1698 # 7718 <malloc+0x1a6e>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	a6250513          	addi	a0,a0,-1438 # 7828 <malloc+0x1b7e>
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	e24080e7          	jalr	-476(ra) # 5bf2 <printf>
      exit(1);
    3dd6:	4505                	li	a0,1
    ...
    3de6:	a5e50513          	addi	a0,a0,-1442 # 7840 <malloc+0x1b96>
    3dea:	00002097          	auipc	ra,0x2
    3dee:	e08080e7          	jalr	-504(ra) # 5bf2 <printf>
      exit(1);
    3df2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	1d298993          	addi	s3,s3,466 # 7048 <malloc+0x139e>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	9a290913          	addi	s2,s2,-1630 # 7820 <malloc+0x1b76>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	15250513          	addi	a0,a0,338 # 6ff0 <malloc+0x1346>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	98a50513          	addi	a0,a0,-1654 # 7858 <malloc+0x1bae>
  ...
  if(pid == 0){
    ...
    3ef6:	96650513          	addi	a0,a0,-1690 # 7858 <malloc+0x1bae>
    ...
    3f0c:	97050513          	addi	a0,a0,-1680 # 7878 <malloc+0x1bce>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	ce2080e7          	jalr	-798(ra) # 5bf2 <printf>
      exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	93c50513          	addi	a0,a0,-1732 # 7860 <malloc+0x1bb6>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	cc6080e7          	jalr	-826(ra) # 5bf2 <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	6e050513          	addi	a0,a0,1760 # 6620 <malloc+0x976>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	caa080e7          	jalr	-854(ra) # 5bf2 <printf>
    exit(1);
    3f50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	8ea50513          	addi	a0,a0,-1814 # 7858 <malloc+0x1bae>
    ...
    3f86:	88e50513          	addi	a0,a0,-1906 # 6810 <malloc+0xb66>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	c68080e7          	jalr	-920(ra) # 5bf2 <printf>
    exit(1);
    3f92:	4505                	li	a0,1
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	8e050513          	addi	a0,a0,-1824 # 78a0 <malloc+0x1bf6>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	8b450513          	addi	a0,a0,-1868 # 78a0 <malloc+0x1bf6>
  ...
  sleep(10); // one second
    ...
    4028:	7bc50513          	addi	a0,a0,1980 # 67e0 <malloc+0xb36>
    402c:	00002097          	auipc	ra,0x2
    4030:	bc6080e7          	jalr	-1082(ra) # 5bf2 <printf>
    exit(1);
    4034:	4505                	li	a0,1
    ...
    4042:	86248493          	addi	s1,s1,-1950 # 78a0 <malloc+0x1bf6>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
...
0000000000004084 <killstatus>:
{
  ...
  exit(0);
    ...
    40ea:	53a50513          	addi	a0,a0,1338 # 6620 <malloc+0x976>
    40ee:	00002097          	auipc	ra,0x2
    40f2:	b04080e7          	jalr	-1276(ra) # 5bf2 <printf>
      exit(1);
    40f6:	4505                	li	a0,1
    ...
    4110:	7a450513          	addi	a0,a0,1956 # 78b0 <malloc+0x1c06>
    4114:	00002097          	auipc	ra,0x2
    4118:	ade080e7          	jalr	-1314(ra) # 5bf2 <printf>
       exit(1);
    411c:	4505                	li	a0,1
...
0000000000004126 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4150:	69450513          	addi	a0,a0,1684 # 67e0 <malloc+0xb36>
    4154:	00002097          	auipc	ra,0x2
    4158:	a9e080e7          	jalr	-1378(ra) # 5bf2 <printf>
    exit(1);
    415c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    417e:	4a650513          	addi	a0,a0,1190 # 6620 <malloc+0x976>
    4182:	00002097          	auipc	ra,0x2
    4186:	a70080e7          	jalr	-1424(ra) # 5bf2 <printf>
    exit(1);
    418a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c2:	c7a58593          	addi	a1,a1,-902 # 5e38 <malloc+0x18e>
    ...
    41ec:	43850513          	addi	a0,a0,1080 # 6620 <malloc+0x976>
    41f0:	00002097          	auipc	ra,0x2
    41f4:	a02080e7          	jalr	-1534(ra) # 5bf2 <printf>
     exit(1);
    41f8:	4505                	li	a0,1
    ...
    4208:	6cc50513          	addi	a0,a0,1740 # 78d0 <malloc+0x1c26>
    420c:	00002097          	auipc	ra,0x2
    4210:	9e6080e7          	jalr	-1562(ra) # 5bf2 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4244:	6a850513          	addi	a0,a0,1704 # 78e8 <malloc+0x1c3e>
    4248:	00002097          	auipc	ra,0x2
    424c:	9aa080e7          	jalr	-1622(ra) # 5bf2 <printf>
}
  ...
  printf("kill... ");
    ...
    4270:	69450513          	addi	a0,a0,1684 # 7900 <malloc+0x1c56>
    4274:	00002097          	auipc	ra,0x2
    4278:	97e080e7          	jalr	-1666(ra) # 5bf2 <printf>
  kill(pid1);
    427c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    429e:	67650513          	addi	a0,a0,1654 # 7910 <malloc+0x1c66>
    42a2:	00002097          	auipc	ra,0x2
    42a6:	950080e7          	jalr	-1712(ra) # 5bf2 <printf>
  wait(0);
    42aa:	4501                	li	a0,0
...
00000000000042ca <reparent>:
{
  ...
  exit(0);
    ...
    431e:	30650513          	addi	a0,a0,774 # 6620 <malloc+0x976>
    4322:	00002097          	auipc	ra,0x2
    4326:	8d0080e7          	jalr	-1840(ra) # 5bf2 <printf>
      exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	47250513          	addi	a0,a0,1138 # 67a8 <malloc+0xafe>
    433e:	00002097          	auipc	ra,0x2
    4342:	8b4080e7          	jalr	-1868(ra) # 5bf2 <printf>
        exit(1);
    4346:	4505                	li	a0,1
...
000000000000437a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b0:	37c50513          	addi	a0,a0,892 # 6728 <malloc+0xa7e>
    43b4:	00002097          	auipc	ra,0x2
    43b8:	83e080e7          	jalr	-1986(ra) # 5bf2 <printf>
    exit(1);
    43bc:	4505                	li	a0,1
    ...
    43e4:	a5858593          	addi	a1,a1,-1448 # 5e38 <malloc+0x18e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44a8:	47c50513          	addi	a0,a0,1148 # 7920 <malloc+0x1c76>
    44ac:	00001097          	auipc	ra,0x1
    44b0:	746080e7          	jalr	1862(ra) # 5bf2 <printf>
    exit(1);
    44b4:	4505                	li	a0,1
    ...
    44c4:	16050513          	addi	a0,a0,352 # 6620 <malloc+0x976>
    44c8:	00001097          	auipc	ra,0x1
    44cc:	72a080e7          	jalr	1834(ra) # 5bf2 <printf>
    exit(1);
    44d0:	4505                	li	a0,1
    ...
    4510:	43450513          	addi	a0,a0,1076 # 7940 <malloc+0x1c96>
    4514:	00001097          	auipc	ra,0x1
    4518:	6de080e7          	jalr	1758(ra) # 5bf2 <printf>
    exit(1);
    451c:	4505                	li	a0,1
...
0000000000004530 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    457a:	734080e7          	jalr	1844(ra) # 5caa <malloc>
    ...
    45b4:	3c050513          	addi	a0,a0,960 # 7970 <malloc+0x1cc6>
    45b8:	00001097          	auipc	ra,0x1
    45bc:	63a080e7          	jalr	1594(ra) # 5bf2 <printf>
      exit(1);
    45c0:	4505                	li	a0,1
...
00000000000045d4 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    466a:	33a50513          	addi	a0,a0,826 # 79a0 <malloc+0x1cf6>
    466e:	00001097          	auipc	ra,0x1
    4672:	584080e7          	jalr	1412(ra) # 5bf2 <printf>
    exit(1);
    4676:	4505                	li	a0,1
    ...
    4686:	34650513          	addi	a0,a0,838 # 79c8 <malloc+0x1d1e>
    468a:	00001097          	auipc	ra,0x1
    468e:	568080e7          	jalr	1384(ra) # 5bf2 <printf>
      exit(1);
    4692:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46ca:	2ca50513          	addi	a0,a0,714 # 7990 <malloc+0x1ce6>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    470a:	2e250513          	addi	a0,a0,738 # 79e8 <malloc+0x1d3e>
    470e:	00001097          	auipc	ra,0x1
    4712:	4e4080e7          	jalr	1252(ra) # 5bf2 <printf>
    exit(1);
    4716:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4746:	24e50513          	addi	a0,a0,590 # 7990 <malloc+0x1ce6>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    476c:	2a850513          	addi	a0,a0,680 # 7a10 <malloc+0x1d66>
...
000000000000478c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b2:	27a78793          	addi	a5,a5,634 # 7a28 <malloc+0x1d7e>
    47b6:	f6f43823          	sd	a5,-144(s0)
    47ba:	00003797          	auipc	a5,0x3
    47be:	27678793          	addi	a5,a5,630 # 7a30 <malloc+0x1d86>
    47c2:	f6f43c23          	sd	a5,-136(s0)
    47c6:	00003797          	auipc	a5,0x3
    47ca:	27278793          	addi	a5,a5,626 # 7a38 <malloc+0x1d8e>
    47ce:	f8f43023          	sd	a5,-128(s0)
    47d2:	00003797          	auipc	a5,0x3
    47d6:	26e78793          	addi	a5,a5,622 # 7a40 <malloc+0x1d96>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    484e:	1f650513          	addi	a0,a0,502 # 6a40 <malloc+0xd96>
    4852:	00001097          	auipc	ra,0x1
    4856:	3a0080e7          	jalr	928(ra) # 5bf2 <printf>
      exit(1);
    485a:	4505                	li	a0,1
    ...
    48ca:	18250513          	addi	a0,a0,386 # 7a48 <malloc+0x1d9e>
    48ce:	00001097          	auipc	ra,0x1
    48d2:	324080e7          	jalr	804(ra) # 5bf2 <printf>
        exit(1);
    48d6:	4505                	li	a0,1
    ...
    48e4:	17850513          	addi	a0,a0,376 # 7a58 <malloc+0x1dae>
    48e8:	00001097          	auipc	ra,0x1
    48ec:	30a080e7          	jalr	778(ra) # 5bf2 <printf>
          exit(1);
    48f0:	4505                	li	a0,1
    ...
    490c:	16850513          	addi	a0,a0,360 # 7a70 <malloc+0x1dc6>
    4910:	00001097          	auipc	ra,0x1
    4914:	2e2080e7          	jalr	738(ra) # 5bf2 <printf>
          exit(1);
    4918:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    499a:	0ea50513          	addi	a0,a0,234 # 7a80 <malloc+0x1dd6>
    499e:	00001097          	auipc	ra,0x1
    49a2:	254080e7          	jalr	596(ra) # 5bf2 <printf>
      exit(1);
    49a6:	4505                	li	a0,1
...
00000000000049ce <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    49fc:	0a0b8b93          	addi	s7,s7,160 # 7a98 <malloc+0x1dee>
  for(i = 0; i < N; i++){
    ...
    4a3e:	06650513          	addi	a0,a0,102 # 7aa0 <malloc+0x1df6>
    4a42:	00001097          	auipc	ra,0x1
    4a46:	1b0080e7          	jalr	432(ra) # 5bf2 <printf>
        exit(1);
    4a4a:	4505                	li	a0,1
    ...
    4a5c:	04050513          	addi	a0,a0,64 # 7a98 <malloc+0x1dee>
  ...
  fd = open(".", 0);
    ...
    4a94:	9f050513          	addi	a0,a0,-1552 # 6480 <malloc+0x7d6>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b0c:	fb850513          	addi	a0,a0,-72 # 7ac0 <malloc+0x1e16>
    4b10:	00001097          	auipc	ra,0x1
    4b14:	0e2080e7          	jalr	226(ra) # 5bf2 <printf>
        exit(1);
    4b18:	4505                	li	a0,1
    ...
    4b2c:	fb850513          	addi	a0,a0,-72 # 7ae0 <malloc+0x1e36>
    4b30:	00001097          	auipc	ra,0x1
    4b34:	0c2080e7          	jalr	194(ra) # 5bf2 <printf>
        exit(1);
    4b38:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b64:	fa850513          	addi	a0,a0,-88 # 7b08 <malloc+0x1e5e>
    4b68:	00001097          	auipc	ra,0x1
    4b6c:	08a080e7          	jalr	138(ra) # 5bf2 <printf>
    exit(1);
    4b70:	4505                	li	a0,1
    ...
    4b80:	aa450513          	addi	a0,a0,-1372 # 6620 <malloc+0x976>
    4b84:	00001097          	auipc	ra,0x1
    4b88:	06e080e7          	jalr	110(ra) # 5bf2 <printf>
      exit(1);
    4b8c:	4505                	li	a0,1
...
0000000000004d2a <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db2:	d9250513          	addi	a0,a0,-622 # 7b40 <malloc+0x1e96>
  ...
  for(i = 0; ; i++){
    ...
    4e16:	d3e50513          	addi	a0,a0,-706 # 7b50 <malloc+0x1ea6>
    4e1a:	00001097          	auipc	ra,0x1
    4e1e:	dd8080e7          	jalr	-552(ra) # 5bf2 <printf>
    exit(1);
    4e22:	4505                	li	a0,1
    ...
    4e32:	d4250513          	addi	a0,a0,-702 # 7b70 <malloc+0x1ec6>
    4e36:	00001097          	auipc	ra,0x1
    4e3a:	dbc080e7          	jalr	-580(ra) # 5bf2 <printf>
      exit(1);
    4e3e:	4505                	li	a0,1
    ...
    4e4e:	d4650513          	addi	a0,a0,-698 # 7b90 <malloc+0x1ee6>
    4e52:	00001097          	auipc	ra,0x1
    4e56:	da0080e7          	jalr	-608(ra) # 5bf2 <printf>
    exit(1);
    4e5a:	4505                	li	a0,1
    ...
    4e6a:	d4a50513          	addi	a0,a0,-694 # 7bb0 <malloc+0x1f06>
    4e6e:	00001097          	auipc	ra,0x1
    4e72:	d84080e7          	jalr	-636(ra) # 5bf2 <printf>
      exit(1);
    4e76:	4505                	li	a0,1
    ...
    4e86:	d4e50513          	addi	a0,a0,-690 # 7bd0 <malloc+0x1f26>
    4e8a:	00001097          	auipc	ra,0x1
    4e8e:	d68080e7          	jalr	-664(ra) # 5bf2 <printf>
      exit(1);
    4e92:	4505                	li	a0,1
    ...
    4ea2:	d4a50513          	addi	a0,a0,-694 # 7be8 <malloc+0x1f3e>
    4ea6:	00001097          	auipc	ra,0x1
    4eaa:	d4c080e7          	jalr	-692(ra) # 5bf2 <printf>
      exit(1);
    4eae:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed0:	c7450513          	addi	a0,a0,-908 # 7b40 <malloc+0x1e96>
    ...
    4ef4:	d1850513          	addi	a0,a0,-744 # 7c08 <malloc+0x1f5e>
...
0000000000004f0a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f2c:	d0050513          	addi	a0,a0,-768 # 7c28 <malloc+0x1f7e>
    4f30:	00001097          	auipc	ra,0x1
    4f34:	cc2080e7          	jalr	-830(ra) # 5bf2 <printf>
  for(nfiles = 0; ; nfiles++){
    4f38:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f4c:	cf0c8c93          	addi	s9,s9,-784 # 7c38 <malloc+0x1f8e>
    int total = 0;
    4f50:	4d81                	li	s11,0
    ...
    4fa4:	c52080e7          	jalr	-942(ra) # 5bf2 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fc6:	c8650513          	addi	a0,a0,-890 # 7c48 <malloc+0x1f9e>
    4fca:	00001097          	auipc	ra,0x1
    4fce:	c28080e7          	jalr	-984(ra) # 5bf2 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    503c:	c3050513          	addi	a0,a0,-976 # 7c68 <malloc+0x1fbe>
    5040:	00001097          	auipc	ra,0x1
    5044:	bb2080e7          	jalr	-1102(ra) # 5bf2 <printf>
}
    ...
    508c:	bd050513          	addi	a0,a0,-1072 # 7c58 <malloc+0x1fae>
    5090:	00001097          	auipc	ra,0x1
    5094:	b62080e7          	jalr	-1182(ra) # 5bf2 <printf>
    close(fd);
    5098:	854a                	mv	a0,s2
...
00000000000050aa <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    511e:	b6650513          	addi	a0,a0,-1178 # 7c80 <malloc+0x1fd6>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5136:	d0658593          	addi	a1,a1,-762 # 5e38 <malloc+0x18e>
    ...
    514c:	b5850513          	addi	a0,a0,-1192 # 7ca0 <malloc+0x1ff6>
    5150:	00001097          	auipc	ra,0x1
    5154:	aa2080e7          	jalr	-1374(ra) # 5bf2 <printf>
    exit(1);
    5158:	4505                	li	a0,1
    ...
    5166:	b2650513          	addi	a0,a0,-1242 # 7c88 <malloc+0x1fde>
    516a:	00001097          	auipc	ra,0x1
    516e:	a88080e7          	jalr	-1400(ra) # 5bf2 <printf>
      exit(1);
    5172:	4505                	li	a0,1
    ...
    5180:	b0c50513          	addi	a0,a0,-1268 # 7c88 <malloc+0x1fde>
    5184:	00001097          	auipc	ra,0x1
    5188:	a6e080e7          	jalr	-1426(ra) # 5bf2 <printf>
    exit(1);
    518c:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a4:	ae050513          	addi	a0,a0,-1312 # 7c80 <malloc+0x1fd6>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fa:	c4298993          	addi	s3,s3,-958 # 5e38 <malloc+0x18e>
      uint64 a = (uint64) sbrk(4096);
    ...
    522c:	ac850513          	addi	a0,a0,-1336 # 7cf0 <malloc+0x2046>
    5230:	00001097          	auipc	ra,0x1
    5234:	9c2080e7          	jalr	-1598(ra) # 5bf2 <printf>
        exit(1);
    5238:	4505                	li	a0,1
    ...
    5246:	a6e50513          	addi	a0,a0,-1426 # 7cb0 <malloc+0x2006>
    524a:	00001097          	auipc	ra,0x1
    524e:	9a8080e7          	jalr	-1624(ra) # 5bf2 <printf>
    exit(1);
    5252:	4505                	li	a0,1
    ...
    5260:	a7450513          	addi	a0,a0,-1420 # 7cd0 <malloc+0x2026>
    5264:	00001097          	auipc	ra,0x1
    5268:	98e080e7          	jalr	-1650(ra) # 5bf2 <printf>
    exit(1);
    526c:	4505                	li	a0,1
  ...
  while(1){
    ...
    52ae:	a6650513          	addi	a0,a0,-1434 # 7d10 <malloc+0x2066>
    52b2:	00001097          	auipc	ra,0x1
    52b6:	940080e7          	jalr	-1728(ra) # 5bf2 <printf>
      exit(1);
    52ba:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52fe:	a3650513          	addi	a0,a0,-1482 # 7d30 <malloc+0x2086>
    5302:	00001097          	auipc	ra,0x1
    5306:	8f0080e7          	jalr	-1808(ra) # 5bf2 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    532e:	a2e50513          	addi	a0,a0,-1490 # 7d58 <malloc+0x20ae>
    5332:	00001097          	auipc	ra,0x1
    5336:	8c0080e7          	jalr	-1856(ra) # 5bf2 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5352:	9f250513          	addi	a0,a0,-1550 # 7d40 <malloc+0x2096>
    5356:	00001097          	auipc	ra,0x1
    535a:	89c080e7          	jalr	-1892(ra) # 5bf2 <printf>
    exit(1);
    535e:	4505                	li	a0,1
    ...
    537a:	9ea50513          	addi	a0,a0,-1558 # 7d60 <malloc+0x20b6>
    537e:	00001097          	auipc	ra,0x1
    5382:	874080e7          	jalr	-1932(ra) # 5bf2 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c4:	db878793          	addi	a5,a5,-584 # 8178 <malloc+0x24ce>
    53c8:	bd040713          	addi	a4,s0,-1072
    53cc:	00003317          	auipc	t1,0x3
    53d0:	19c30313          	addi	t1,t1,412 # 8568 <malloc+0x28be>
  ...
  printf("usertests starting\n");
    ...
    5404:	a1850513          	addi	a0,a0,-1512 # 7e18 <malloc+0x216e>
    5408:	00000097          	auipc	ra,0x0
    540c:	7ea080e7          	jalr	2026(ra) # 5bf2 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    543c:	99850513          	addi	a0,a0,-1640 # 7dd0 <malloc+0x2126>
    5440:	00000097          	auipc	ra,0x0
    5444:	7b2080e7          	jalr	1970(ra) # 5bf2 <printf>
    exit(1);
    5448:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5458:	91458593          	addi	a1,a1,-1772 # 7d68 <malloc+0x20be>
    ...
    546e:	9e658593          	addi	a1,a1,-1562 # 7e50 <malloc+0x21a6>
    ...
    5492:	8e250513          	addi	a0,a0,-1822 # 7d70 <malloc+0x20c6>
    5496:	00000097          	auipc	ra,0x0
    549a:	75c080e7          	jalr	1884(ra) # 5bf2 <printf>
    exit(1);
    549e:	4505                	li	a0,1
    ...
    54bc:	73a080e7          	jalr	1850(ra) # 5bf2 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    54fe:	8be50513          	addi	a0,a0,-1858 # 7db8 <malloc+0x210e>
    5502:	00000097          	auipc	ra,0x0
    5506:	6f0080e7          	jalr	1776(ra) # 5bf2 <printf>
    exit(1);
    550a:	4505                	li	a0,1
    ...
    5518:	8ec50513          	addi	a0,a0,-1812 # 7e00 <malloc+0x2156>
    551c:	00000097          	auipc	ra,0x0
    5520:	6d6080e7          	jalr	1750(ra) # 5bf2 <printf>
    exit(0);
    5524:	4501                	li	a0,0
    ...
    5534:	6c2080e7          	jalr	1730(ra) # 5bf2 <printf>
        if(continuous != 2)
    ...
    5576:	c0678793          	addi	a5,a5,-1018 # 8178 <malloc+0x24ce>
    557a:	bd040713          	addi	a4,s0,-1072
    557e:	00003317          	auipc	t1,0x3
    5582:	fea30313          	addi	t1,t1,-22 # 8568 <malloc+0x28be>
    ...
    55b6:	87e50513          	addi	a0,a0,-1922 # 7e30 <malloc+0x2186>
    55ba:	00000097          	auipc	ra,0x0
    55be:	638080e7          	jalr	1592(ra) # 5bf2 <printf>
        printf("SOME TESTS FAILED\n");
    55c2:	00002a97          	auipc	s5,0x2
    55c6:	7f6a8a93          	addi	s5,s5,2038 # 7db8 <malloc+0x210e>
        if(continuous != 2)
    55ca:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55cc:	00002b17          	auipc	s6,0x2
    55d0:	7ccb0b13          	addi	s6,s6,1996 # 7d98 <malloc+0x20ee>
...
ugetpid(void)
{
  ...
  return u->pid;
    ...
    5844:	17f5                	addi	a5,a5,-3 # 3fffffd <__BSS_END__+0x3ff11e5>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    592e:	f4e080e7          	jalr	-178(ra) # 5878 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    594c:	0805c963          	bltz	a1,59de <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    ...
    5960:	c6c50513          	addi	a0,a0,-916 # 85c8 <digits>
    5964:	883a                	mv	a6,a4
  ...
  if(neg)
    5988:	00088c63          	beqz	a7,59a0 <printint+0x66>
    buf[i++] = '-';
    598c:	fd070793          	addi	a5,a4,-48
    5990:	00878733          	add	a4,a5,s0
    5994:	02d00793          	li	a5,45
    5998:	fef70823          	sb	a5,-16(a4)
    599c:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    59a0:	02e05863          	blez	a4,59d0 <printint+0x96>
    ...
    59c6:	f56080e7          	jalr	-170(ra) # 5918 <putc>
  while(--i >= 0)
    59ca:	197d                	addi	s2,s2,-1
    59cc:	ff3918e3          	bne	s2,s3,59bc <printint+0x82>
}
    ...
    59e2:	4885                	li	a7,1
    x = -xx;
    59e4:	bf85                	j	5954 <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5a1a:	4c55                	li	s8,21
    5a1c:	00003c97          	auipc	s9,0x3
    5a20:	b54c8c93          	addi	s9,s9,-1196 # 8570 <malloc+0x28c6>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    5a24:	02800d93          	li	s11,40
  putc(fd, 'x');
    5a28:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a2a:	00003b97          	auipc	s7,0x3
    5a2e:	b9eb8b93          	addi	s7,s7,-1122 # 85c8 <digits>
    5a32:	a839                	j	5a50 <vprintf+0x6a>
        putc(fd, c);
    5a34:	85ca                	mv	a1,s2
    5a36:	8556                	mv	a0,s5
    5a38:	00000097          	auipc	ra,0x0
    5a3c:	ee0080e7          	jalr	-288(ra) # 5918 <putc>
    5a40:	a019                	j	5a46 <vprintf+0x60>
    } else if(state == '%'){
    5a42:	01498d63          	beq	s3,s4,5a5c <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5a46:	0485                	addi	s1,s1,1
    5a48:	fff4c903          	lbu	s2,-1(s1)
    5a4c:	14090d63          	beqz	s2,5ba6 <vprintf+0x1c0>
    if(state == 0){
    5a50:	fe0999e3          	bnez	s3,5a42 <vprintf+0x5c>
      if(c == '%'){
    5a54:	ff4910e3          	bne	s2,s4,5a34 <vprintf+0x4e>
        state = '%';
    5a58:	89d2                	mv	s3,s4
    5a5a:	b7f5                	j	5a46 <vprintf+0x60>
      if(c == 'd'){
    5a5c:	11490c63          	beq	s2,s4,5b74 <vprintf+0x18e>
    5a60:	f9d9079b          	addiw	a5,s2,-99
    5a64:	0ff7f793          	zext.b	a5,a5
    5a68:	10fc6e63          	bltu	s8,a5,5b84 <vprintf+0x19e>
    5a6c:	f9d9079b          	addiw	a5,s2,-99
    5a70:	0ff7f713          	zext.b	a4,a5
    5a74:	10ec6863          	bltu	s8,a4,5b84 <vprintf+0x19e>
    5a78:	00271793          	slli	a5,a4,0x2
    5a7c:	97e6                	add	a5,a5,s9
    5a7e:	439c                	lw	a5,0(a5)
    5a80:	97e6                	add	a5,a5,s9
    5a82:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5a84:	008b0913          	addi	s2,s6,8
    5a88:	4685                	li	a3,1
    5a8a:	4629                	li	a2,10
    5a8c:	000b2583          	lw	a1,0(s6)
    5a90:	8556                	mv	a0,s5
    5a92:	00000097          	auipc	ra,0x0
    5a96:	ea8080e7          	jalr	-344(ra) # 593a <printint>
    5a9a:	8b4a                	mv	s6,s2
      } else {
    ...
    5ab2:	e8c080e7          	jalr	-372(ra) # 593a <printint>
    5ab6:	8b4a                	mv	s6,s2
      state = 0;
    5ab8:	4981                	li	s3,0
    ...
    5ace:	e70080e7          	jalr	-400(ra) # 593a <printint>
    5ad2:	8b4a                	mv	s6,s2
      state = 0;
    5ad4:	4981                	li	s3,0
    5ad6:	bf85                	j	5a46 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5ad8:	008b0793          	addi	a5,s6,8
    5adc:	f8f43423          	sd	a5,-120(s0)
    5ae0:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5ae4:	03000593          	li	a1,48
    5ae8:	8556                	mv	a0,s5
    5aea:	00000097          	auipc	ra,0x0
    5aee:	e2e080e7          	jalr	-466(ra) # 5918 <putc>
  putc(fd, 'x');
    5af2:	07800593          	li	a1,120
    5af6:	8556                	mv	a0,s5
    5af8:	00000097          	auipc	ra,0x0
    5afc:	e20080e7          	jalr	-480(ra) # 5918 <putc>
    5b00:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    5b12:	e0a080e7          	jalr	-502(ra) # 5918 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b16:	0992                	slli	s3,s3,0x4
    5b18:	397d                	addiw	s2,s2,-1
    5b1a:	fe0914e3          	bnez	s2,5b02 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5b1e:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b22:	4981                	li	s3,0
    5b24:	b70d                	j	5a46 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b26:	008b0913          	addi	s2,s6,8
    5b2a:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5b2e:	02098163          	beqz	s3,5b50 <vprintf+0x16a>
        while(*s != 0){
    5b32:	0009c583          	lbu	a1,0(s3)
    5b36:	c5ad                	beqz	a1,5ba0 <vprintf+0x1ba>
          putc(fd, *s);
    5b38:	8556                	mv	a0,s5
    5b3a:	00000097          	auipc	ra,0x0
    5b3e:	dde080e7          	jalr	-546(ra) # 5918 <putc>
          s++;
    5b42:	0985                	addi	s3,s3,1
        while(*s != 0){
    5b44:	0009c583          	lbu	a1,0(s3)
    5b48:	f9e5                	bnez	a1,5b38 <vprintf+0x152>
        s = va_arg(ap, char*);
    5b4a:	8b4a                	mv	s6,s2
      state = 0;
    5b4c:	4981                	li	s3,0
    5b4e:	bde5                	j	5a46 <vprintf+0x60>
          s = "(null)";
    5b50:	00003997          	auipc	s3,0x3
    5b54:	a1898993          	addi	s3,s3,-1512 # 8568 <malloc+0x28be>
        while(*s != 0){
    5b58:	85ee                	mv	a1,s11
    5b5a:	bff9                	j	5b38 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5b5c:	008b0913          	addi	s2,s6,8
    5b60:	000b4583          	lbu	a1,0(s6)
    5b64:	8556                	mv	a0,s5
    5b66:	00000097          	auipc	ra,0x0
    5b6a:	db2080e7          	jalr	-590(ra) # 5918 <putc>
    5b6e:	8b4a                	mv	s6,s2
      state = 0;
    5b70:	4981                	li	s3,0
    5b72:	bdd1                	j	5a46 <vprintf+0x60>
        putc(fd, c);
    5b74:	85d2                	mv	a1,s4
    5b76:	8556                	mv	a0,s5
    5b78:	00000097          	auipc	ra,0x0
    5b7c:	da0080e7          	jalr	-608(ra) # 5918 <putc>
      state = 0;
    5b80:	4981                	li	s3,0
    5b82:	b5d1                	j	5a46 <vprintf+0x60>
        putc(fd, '%');
    5b84:	85d2                	mv	a1,s4
    5b86:	8556                	mv	a0,s5
    5b88:	00000097          	auipc	ra,0x0
    5b8c:	d90080e7          	jalr	-624(ra) # 5918 <putc>
        putc(fd, c);
    5b90:	85ca                	mv	a1,s2
    5b92:	8556                	mv	a0,s5
    5b94:	00000097          	auipc	ra,0x0
    5b98:	d84080e7          	jalr	-636(ra) # 5918 <putc>
      state = 0;
    5b9c:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5c36:	9b67b783          	ld	a5,-1610(a5) # 85e8 <freep>
    5c3a:	a02d                	j	5c64 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c3c:	4618                	lw	a4,8(a2)
    5c3e:	9f2d                	addw	a4,a4,a1
    5c40:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c44:	6398                	ld	a4,0(a5)
    5c46:	6310                	ld	a2,0(a4)
    5c48:	a83d                	j	5c86 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c4a:	ff852703          	lw	a4,-8(a0)
    5c4e:	9f31                	addw	a4,a4,a2
    5c50:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5c52:	ff053683          	ld	a3,-16(a0)
    5c56:	a091                	j	5c9a <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c58:	6398                	ld	a4,0(a5)
    5c5a:	00e7e463          	bltu	a5,a4,5c62 <free+0x3a>
    5c5e:	00e6ea63          	bltu	a3,a4,5c72 <free+0x4a>
{
    5c62:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c64:	fed7fae3          	bgeu	a5,a3,5c58 <free+0x30>
    5c68:	6398                	ld	a4,0(a5)
    5c6a:	00e6e463          	bltu	a3,a4,5c72 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c6e:	fee7eae3          	bltu	a5,a4,5c62 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5c72:	ff852583          	lw	a1,-8(a0)
    5c76:	6390                	ld	a2,0(a5)
    5c78:	02059813          	slli	a6,a1,0x20
    5c7c:	01c85713          	srli	a4,a6,0x1c
    5c80:	9736                	add	a4,a4,a3
    5c82:	fae60de3          	beq	a2,a4,5c3c <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5c86:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c8a:	4790                	lw	a2,8(a5)
    5c8c:	02061593          	slli	a1,a2,0x20
    5c90:	01c5d713          	srli	a4,a1,0x1c
    5c94:	973e                	add	a4,a4,a5
    5c96:	fae68ae3          	beq	a3,a4,5c4a <free+0x22>
    p->s.ptr = bp->s.ptr;
    5c9a:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5c9c:	00003717          	auipc	a4,0x3
    5ca0:	94f73623          	sd	a5,-1716(a4) # 85e8 <freep>
}
    5ca4:	6422                	ld	s0,8(sp)
    5ca6:	0141                	addi	sp,sp,16
    5ca8:	8082                	ret

0000000000005caa <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    5cb6:	e852                	sd	s4,16(sp)
    5cb8:	e456                	sd	s5,8(sp)
    5cba:	e05a                	sd	s6,0(sp)
    5cbc:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5cbe:	02051493          	slli	s1,a0,0x20
    5cc2:	9081                	srli	s1,s1,0x20
    5cc4:	04bd                	addi	s1,s1,15
    5cc6:	8091                	srli	s1,s1,0x4
    5cc8:	0014899b          	addiw	s3,s1,1
    5ccc:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5cce:	00003517          	auipc	a0,0x3
    5cd2:	91a53503          	ld	a0,-1766(a0) # 85e8 <freep>
    5cd6:	c515                	beqz	a0,5d02 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5cd8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5cda:	4798                	lw	a4,8(a5)
    5cdc:	02977f63          	bgeu	a4,s1,5d1a <malloc+0x70>
    5ce0:	8a4e                	mv	s4,s3
    5ce2:	0009871b          	sext.w	a4,s3
    5ce6:	6685                	lui	a3,0x1
    5ce8:	00d77363          	bgeu	a4,a3,5cee <malloc+0x44>
    5cec:	6a05                	lui	s4,0x1
    5cee:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cf2:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5cf6:	00003917          	auipc	s2,0x3
    5cfa:	8f290913          	addi	s2,s2,-1806 # 85e8 <freep>
  if(p == (char*)-1)
    5cfe:	5afd                	li	s5,-1
    5d00:	a895                	j	5d74 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5d02:	00009797          	auipc	a5,0x9
    5d06:	10678793          	addi	a5,a5,262 # ee08 <base>
    5d0a:	00003717          	auipc	a4,0x3
    5d0e:	8cf73f23          	sd	a5,-1826(a4) # 85e8 <freep>
    5d12:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5d14:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5d18:	b7e1                	j	5ce0 <malloc+0x36>
      if(p->s.size == nunits)
    5d1a:	02e48c63          	beq	s1,a4,5d52 <malloc+0xa8>
        p->s.size -= nunits;
    5d1e:	4137073b          	subw	a4,a4,s3
    5d22:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d24:	02071693          	slli	a3,a4,0x20
    5d28:	01c6d713          	srli	a4,a3,0x1c
    5d2c:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d2e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d32:	00003717          	auipc	a4,0x3
    5d36:	8aa73b23          	sd	a0,-1866(a4) # 85e8 <freep>
      return (void*)(p + 1);
    5d3a:	01078513          	addi	a0,a5,16
    ...
    5d48:	6a42                	ld	s4,16(sp)
    5d4a:	6aa2                	ld	s5,8(sp)
    5d4c:	6b02                	ld	s6,0(sp)
    5d4e:	6121                	addi	sp,sp,64
    5d50:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d52:	6398                	ld	a4,0(a5)
    5d54:	e118                	sd	a4,0(a0)
    5d56:	bff1                	j	5d32 <malloc+0x88>
  hp->s.size = nu;
    5d58:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d5c:	0541                	addi	a0,a0,16
    5d5e:	00000097          	auipc	ra,0x0
    5d62:	eca080e7          	jalr	-310(ra) # 5c28 <free>
  return freep;
    5d66:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d6a:	d971                	beqz	a0,5d3e <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d6c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d6e:	4798                	lw	a4,8(a5)
    5d70:	fa9775e3          	bgeu	a4,s1,5d1a <malloc+0x70>
    if(p == freep)
    5d74:	00093703          	ld	a4,0(s2)
    5d78:	853e                	mv	a0,a5
    5d7a:	fef719e3          	bne	a4,a5,5d6c <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5d7e:	8552                	mv	a0,s4
    5d80:	00000097          	auipc	ra,0x0
    5d84:	b60080e7          	jalr	-1184(ra) # 58e0 <sbrk>
  if(p == (char*)-1)
    5d88:	fd5518e3          	bne	a0,s5,5d58 <malloc+0xae>
        return 0;
    5d8c:	4501                	li	a0,0
    5d8e:	bf45                	j	5d3e <malloc+0x94>
