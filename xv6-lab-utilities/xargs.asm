...
int main(int argc, char *argv[]) 
{
  ...
  14:	4785                	li	a5,1
  16:	04a7d463          	bge	a5,a0,5e <main+0x5e>
  1a:	00858713          	addi	a4,a1,8
  1e:	ec040793          	addi	a5,s0,-320
  22:	ffe5061b          	addiw	a2,a0,-2
  26:	02061693          	slli	a3,a2,0x20
  2a:	01d6d613          	srli	a2,a3,0x1d
  2e:	ec840693          	addi	a3,s0,-312
  32:	9636                	add	a2,a2,a3
    {
  ...
  3c:	fec79ce3          	bne	a5,a2,34 <main+0x34>
  40:	894e                	mv	s2,s3
    }
  ...
  42:	fff9079b          	addiw	a5,s2,-1
  46:	078e                	slli	a5,a5,0x3
  48:	fc078793          	addi	a5,a5,-64
  4c:	97a2                	add	a5,a5,s0
  4e:	e3840493          	addi	s1,s0,-456
  52:	f097b023          	sd	s1,-256(a5)
   
    while(read(0,&ch,sizeof(char)))
    {
        if( ch == ' ')
  56:	02000a13          	li	s4,32
            *cur_buf = '\0';
            cur_buf++;
  ...
  5a:	4aa9                	li	s5,10
    while(read(0,&ch,sizeof(char)))
  5c:	a831                	j	78 <main+0x78>
    for( cur_argv = 1 ;cur_argv <= argc - 1 ; cur_argv++)
  5e:	4905                	li	s2,1
  60:	b7cd                	j	42 <main+0x42>
            *cur_buf = '\0';
  62:	00048023          	sb	zero,0(s1)
            cur_buf++;
  66:	0485                	addi	s1,s1,1
            new_argv[cur_argv ] = cur_buf;
  68:	00391793          	slli	a5,s2,0x3
  6c:	fc078793          	addi	a5,a5,-64
  70:	97a2                	add	a5,a5,s0
  72:	f097b023          	sd	s1,-256(a5)
            cur_argv++;
  76:	2905                	addiw	s2,s2,1
    while(read(0,&ch,sizeof(char)))
  78:	4605                	li	a2,1
  7a:	ebf40593          	addi	a1,s0,-321
  7e:	4501                	li	a0,0
  80:	00000097          	auipc	ra,0x0
  84:	2f2080e7          	jalr	754(ra) # 372 <read>
  88:	cd39                	beqz	a0,e6 <main+0xe6>
        if( ch == ' ')
  8a:	ebf44783          	lbu	a5,-321(s0)
  8e:	fd478ae3          	beq	a5,s4,62 <main+0x62>
        else if( ch == '\n' )
  92:	01578663          	beq	a5,s5,9e <main+0x9e>
                cur_argv = argc;
            }
        }
        else
        {
            *cur_buf = ch;
  96:	00f48023          	sb	a5,0(s1)
            cur_buf++;
  9a:	0485                	addi	s1,s1,1
  9c:	bff1                	j	78 <main+0x78>
            *cur_buf = '\0';
  9e:	00048023          	sb	zero,0(s1)
            new_argv[cur_argv] = 0;
  a2:	090e                	slli	s2,s2,0x3
  a4:	fc090793          	addi	a5,s2,-64
  a8:	00878933          	add	s2,a5,s0
  ac:	f0093023          	sd	zero,-256(s2)
            int pid = fork();
  b0:	00000097          	auipc	ra,0x0
  b4:	2a2080e7          	jalr	674(ra) # 352 <fork>
            if( pid == 0)
  b8:	c911                	beqz	a0,cc <main+0xcc>
                wait((int*)0);
  ba:	4501                	li	a0,0
  bc:	00000097          	auipc	ra,0x0
  c0:	2a6080e7          	jalr	678(ra) # 362 <wait>
                cur_argv = argc;
  c4:	894e                	mv	s2,s3
                cur_buf = buf;
  c6:	e3840493          	addi	s1,s0,-456
  ca:	b77d                	j	78 <main+0x78>
                exec(new_argv[0] , new_argv);
  cc:	ec040593          	addi	a1,s0,-320
  d0:	ec043503          	ld	a0,-320(s0)
  d4:	00000097          	auipc	ra,0x0
  d8:	2be080e7          	jalr	702(ra) # 392 <exec>
                exit(0);
  dc:	4501                	li	a0,0
  de:	00000097          	auipc	ra,0x0
  e2:	27c080e7          	jalr	636(ra) # 35a <exit>
        }
    }
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 502:	382c8c93          	addi	s9,s9,898 # 880 <malloc+0xf4>
 ...
 510:	3ccb8b93          	addi	s7,s7,972 # 8d8 <digits>
 ...
 636:	24698993          	addi	s3,s3,582 # 878 <malloc+0xec>
        while(*s != 0){
 63a:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 718:	1dc7b783          	ld	a5,476(a5) # 8f0 <freep>
 ...
 740:	00e6ea63          	bltu	a3,a4,754 <free+0x4a>
{
 ...
 782:	16f73923          	sd	a5,370(a4) # 8f0 <freep>
}
 786:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7b4:	14053503          	ld	a0,320(a0) # 8f0 <freep>
 ...
 7dc:	11890913          	addi	s2,s2,280 # 8f0 <freep>
  if(p == (char*)-1)
 7e0:	5afd                	li	s5,-1
 7e2:	a895                	j	856 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7e4:	00000797          	auipc	a5,0x0
 7e8:	11478793          	addi	a5,a5,276 # 8f8 <base>
 7ec:	00000717          	auipc	a4,0x0
 7f0:	10f73223          	sd	a5,260(a4) # 8f0 <freep>
 7f4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 818:	0ca73e23          	sd	a0,220(a4) # 8f0 <freep>
      return (void*)(p + 1);
